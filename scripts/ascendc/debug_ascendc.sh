...
echo "Custom ascendc 910 path: ${ascendc_910_path}"
echo "Custom ascendc 910b path: ${ascendc_910b_path}"
echo "Package build path: ${build_build_path}"
echo "Package ms path: ${build_ms_path}"

copy_ascendc_custom() {
  cp -r ${ascendc_910_path} ${ascendc_910b_path} ${build_build_path}
  cp -r ${ascendc_910_path} ${ascendc_910b_path} ${build_ms_path}
  cp -r ${ascendc_910_path} ${ascendc_910b_path} ${ms_python_path}
}

delete_ascendc_custom() {
  rm -rf ${ascendc_910_path} ${ascendc_910b_path} ${ms_python_path}/custom_ascendc_*
