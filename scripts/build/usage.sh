...
usage()
{
  ...
  echo "              [-L Tensor-RT path] [-y on|off] [-F on|off] [-G common|auto|ptx] [-o]\\"
  echo ""
  echo "Options:"
  echo "    -d Debug mode"
  ...
  echo "       set auto to detect automatically, set 'ptx' to only build ptx, default: 'auto'. Only effective for GPU currently."
