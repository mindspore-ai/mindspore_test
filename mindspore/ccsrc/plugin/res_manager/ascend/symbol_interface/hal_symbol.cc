 ...
 */
#include "mindspore/ccsrc/plugin/res_manager/ascend/symbol_interface/hal_symbol.h"
#include "mindspore/ccsrc/plugin/res_manager/ascend/symbol_interface/symbol_utils.h"
...
void LoadHalApiSymbol(const std::string &driver_path) {
  ...
  MS_LOG(ERROR) << "Load ascend hal api success!";
}
}  // namespace ascend
}  // namespace device
}  // namespace mindspore
