...
#include "plugin/res_manager/ascend/op_adapter/op_declare/matrix_calculation_ops_declare.h"
#include <string>
#include <vector>
...
INPUT_ATTR_MAP(ScatterElements) = {{4, ATTR_DESC(axis, AnyTraits<int64_t>())},
                                   {5, ATTR_DESC(reduction, AnyTraits<ScatterReduceMode>())}};
