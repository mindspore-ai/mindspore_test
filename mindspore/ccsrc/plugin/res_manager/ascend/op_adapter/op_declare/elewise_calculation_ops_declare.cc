...
#include "plugin/res_manager/ascend/op_adapter/op_declare/elewise_calculation_ops_declare.h"
#include <memory>
#include <string>
#include <vector>
#include "plugin/res_manager/ascend/op_adapter/custom_op_proto/cust_elewise_calculation_ops.h"
