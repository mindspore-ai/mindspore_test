 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_OPTIMIZER_MOE_INIT_ROUTING_QUANTV2_FUSION_H_
#define MINDSPORE_CCSRC_BACKEND_OPTIMIZER_MOE_INIT_ROUTING_QUANTV2_FUSION_H_
#include <vector>
#include <string>
#include <memory>
...
namespace mindspore {
namespace opt {
class MoeInitRoutingQuantV2Fusion : public PatternProcessPass {
 public:
  explicit MoeInitRoutingQuantV2Fusion(bool multigraph = true)
      : PatternProcessPass("moe_init_routing_quantv2_fusion", multigraph) {
  ...
  ~MoeInitRoutingQuantV2Fusion() override = default;
...
#endif  // MINDSPORE_CCSRC_BACKEND_OPTIMIZER_MOE_INIT_ROUTING_QUANTV2_FUSION_H_
