...
CNodePtr SwiGLUDynamicQuantFusion::CreateSwiGLUDynamicQuantNode(const FuncGraphPtr &func_graph, const AnfNodePtr &node,
  ...
  std::string attr_str = GetValue<std::string>(attr_value);
  ...
  common::AnfAlgo::SetOutputTypeAndDetailShape(swiglu_dymaimc_quant_out_types,
                                               swiglu_dymaimc_quant_out_shapes, swiglu_dynamic_quant.get());
