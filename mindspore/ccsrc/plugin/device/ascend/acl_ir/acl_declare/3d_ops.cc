...
REGISTER_ACL_OP(Conv3DBackpropInput).set_run_mode(false).set_extra_supported_datatype({ge::DT_BF16});

REGISTER_ACL_OP(Conv3DBackpropFilter).set_run_mode(false).set_extra_supported_datatype({ge::DT_BF16});
