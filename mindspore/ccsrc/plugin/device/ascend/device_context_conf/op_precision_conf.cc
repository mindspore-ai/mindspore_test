...
void RegOpPrecisionConf(py::module *m) {
  (void)py::class_<OpPrecisionConf, std::shared_ptr<OpPrecisionConf>>(*m, "AscendOpPrecisionConf")
    ...
    .def("matmul_allow_hf32", &OpPrecisionConf::set_matmul_allow_hf32, "Matmul Op allow fp32 to hf32.")
    .def("conv_allow_hf32", &OpPrecisionConf::set_conv_allow_hf32, "Conv Op allow fp32 tp hf32.")
