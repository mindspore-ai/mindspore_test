 ...
 */
#ifndef MINDSPORE_CCSRC_RUNTIME_HARDWARE_ASCEND_GE_GE_DEVICE_RES_MANAGER_H_
#define MINDSPORE_CCSRC_RUNTIME_HARDWARE_ASCEND_GE_GE_DEVICE_RES_MANAGER_H_
...
#endif  // MINDSPORE_CCSRC_RUNTIME_HARDWARE_ASCEND_GE_GE_DEVICE_RES_MANAGER_H_
