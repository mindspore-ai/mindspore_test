...
#include "plugin/device/ascend/kernel/rts/grad_load.h"
...
namespace mindspore {
namespace kernel {
bool GradLoadKernel::Init(const AnfNodePtr &anf_node) {
...
bool GradLoadKernel::Launch(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &,
