...
static void KernelFormatRegister() {
  ...
  MS_CUSTOM_KERNEL_HARDWARE_FORMAT_MAPPING_REG(
    ...
    MS_FORMAT_MAPPING(
      (std::vector<std::string>{kOpFormat_DEFAULT, kOpFormat_DEFAULT, kOpFormat_FRAC_NZ, kOpFormat_FRAC_NZ,
  ...
  MS_CUSTOM_KERNEL_HARDWARE_FORMAT_MAPPING_REG(
    ...
    MS_FORMAT_MAPPING((std::vector<std::string>{kOpFormat_DEFAULT, kOpFormat_DEFAULT, kOpFormat_DEFAULT}),
                      (std::vector<std::string>{})),
    MS_FORMAT_MAPPING(
      (std::vector<std::string>{kOpFormat_DEFAULT, kOpFormat_DEFAULT, kOpFormat_DEFAULT, kOpFormat_DEFAULT,
                                kOpFormat_DEFAULT, kOpFormat_DEFAULT, kOpFormat_DEFAULT}),
      (std::vector<std::string>{})),
    MS_FORMAT_MAPPING(
      (std::vector<std::string>{kOpFormat_DEFAULT, kOpFormat_DEFAULT, kOpFormat_FRAC_NZ, kOpFormat_FRAC_NZ,
