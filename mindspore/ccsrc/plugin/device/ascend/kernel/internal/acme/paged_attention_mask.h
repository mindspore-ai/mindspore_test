 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_INTERNAL_ACME_PAGED_ATTENTION_MASK_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_INTERNAL_ACME_PAGED_ATTENTION_MASK_H_
...
namespace mindspore {
namespace kernel {
class AcmePagedAttentionMask : public AcmeKernelMod {
 public:
  AcmePagedAttentionMask() : AcmeKernelMod() {}
  ~AcmePagedAttentionMask() = default;
