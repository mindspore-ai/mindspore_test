 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_INTERNAL_ACME_CAST_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_INTERNAL_ACME_CAST_H_
...
namespace mindspore {
namespace kernel {
class AcmeCast : public AcmeKernelMod {
 public:
  AcmeCast() : AcmeKernelMod() {}
  ~AcmeCast() = default;
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_INTERNAL_ACME_CAST_H_
