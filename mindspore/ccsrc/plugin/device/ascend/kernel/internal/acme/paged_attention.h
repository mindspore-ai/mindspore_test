 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_INTERNAL_ACME_PAGED_ATTENTION_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_INTERNAL_ACME_PAGED_ATTENTION_H_
...
namespace mindspore {
namespace kernel {
class AcmePagedAttention : public AcmeKernelMod {
 public:
  AcmePagedAttention() : AcmeKernelMod() {}
  ~AcmePagedAttention() = default;
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_INTERNAL_ACME_PAGED_ATTENTION_H_
