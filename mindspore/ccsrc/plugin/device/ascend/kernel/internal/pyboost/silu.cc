...
#include "plugin/device/ascend/kernel/internal/pyboost/silu.h"

#include "common/kernel.h"

namespace mindspore {
namespace kernel {
internal::InternalOpPtr InternalKernelInfoSiLU::CreateKernel(const internal::InputsImmutableInfoList &inputs,
                                                             const internal::OutputsImmutableInfoList &outputs) {
  return internal::CreateSwishOp(inputs, outputs, internal::kInternalSwishOpName);
}

void InternalKernelInfoSiLU::Call(const std::shared_ptr<pyboost::OpRunner> &op, const BaseTensorPtr &input) {
...
MS_INTERNAL_KERNEL_INFO_FACTORY_REG(SiLU, internal::kInternalSwishOpName, InternalKernelInfoSiLU);
}  // namespace kernel
}  // namespace mindspore
