...
#include "plugin/device/ascend/kernel/internal/pyboost/quant_v2.h"

#include "common/kernel.h"

namespace mindspore {
namespace kernel {
internal::InternalOpPtr QuantV2::CreateKernel(const internal::InputsImmutableInfoList &inputs,
