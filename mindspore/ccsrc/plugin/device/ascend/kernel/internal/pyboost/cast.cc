...
void InternalKernelInfoCast::Call(const std::shared_ptr<pyboost::OpRunner> &op, const ValuePtrList input_values) {
  ...
  dst_type_ = static_cast<TypeId>(GetValueWithCheck<int64_t>(input_values[kIndex1]));
