...
class InternalKernelInfo {
 public:
  ...
  static void UpdateAddr(std::vector<internal::RawDeviceAddr> *addrlist, const std::vector<TensorPtr> &tensorlist) {
 ...
 protected:
  bool IsInternalDtypeSupport(const std::vector<TensorPtr> *ms_inputs,
  ...
  void TransInternalShapes(internal::ShapeInfoList *shapelist, const std::vector<TensorPtr> &tensorlist,
                           bool is_input = false);
 ...
 private:
  ...
  void UpdateArgImmutableInfo(std::vector<internal::ArgImmutableInfo> *arginfos,
                              const std::vector<TensorPtr> &tensorlist, bool is_input = false);
