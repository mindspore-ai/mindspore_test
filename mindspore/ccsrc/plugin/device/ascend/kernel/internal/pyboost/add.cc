...
void InternalKernelInfoAdd::Call(const std::shared_ptr<pyboost::OpRunner> &op, const BaseTensorPtr &input_tensor,
                                 const BaseTensorPtr &other_tensor) {
  BaseTensorPtrList inputs = {input_tensor, other_tensor};
