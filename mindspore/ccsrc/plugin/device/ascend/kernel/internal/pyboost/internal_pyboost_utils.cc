...
void GatherOpHash(const mindspore::tensor::TensorPtr &tensor) { GatherType(tensor); }

void GatherTilingHash(const mindspore::tensor::TensorPtr &tensor) { GatherShape(tensor); }
