...
#include "plugin/device/ascend/kernel/hccl/pyboost/dist_comm_all_to_all_v_single.h"
...
void DistCommAllToAllVSingleAscendCustomize(const std::shared_ptr<OpRunner> &op, const BaseTensorPtr &other_tensor,
  ...
  auto run_func = [op, other_tensor, input_tensor, group, send_numel_list, recv_numel_list, rank_size,
                   split_sizes_empty]() {
