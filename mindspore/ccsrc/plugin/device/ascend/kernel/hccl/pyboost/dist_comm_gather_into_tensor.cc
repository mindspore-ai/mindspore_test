...
#include "plugin/device/ascend/kernel/hccl/pyboost/dist_comm_gather_into_tensor.h"
...
namespace kernel {
namespace pyboost {
void DistCommGatherIntoTensorAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &other_tensor,
