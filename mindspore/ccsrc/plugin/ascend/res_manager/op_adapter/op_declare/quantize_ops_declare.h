...
DECLARE_OP_ADAPTER(AscendQuantV2)
DECLARE_OP_USE_OUTPUT(AscendQuantV2)
...
DECLARE_OP_ADAPTER(QuantConv2D)
DECLARE_OP_USE_OUTPUT(QuantConv2D)
...
DECLARE_OP_ADAPTER(DynamicQuant)
DECLARE_OP_USE_OUTPUT(DynamicQuant)
