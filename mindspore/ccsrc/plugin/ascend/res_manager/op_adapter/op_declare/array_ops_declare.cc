...
#include "plugin/ascend/res_manager/op_adapter/op_declare/array_ops_declare.h"
#include <cstdint>
#include <string>
#include <vector>
...
REG_ADPT_DESC(IdentityFormatCast, prim::kPrimFormatCast->name(), ADPT_DESC(Identity))
