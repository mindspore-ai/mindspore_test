...
#include "plugin/ascend/res_manager/op_adapter/custom_op_proto/cust_other_ops.h"
#include "plugin/ascend/res_manager/op_adapter/custom_op_proto/flash_attention.h"
