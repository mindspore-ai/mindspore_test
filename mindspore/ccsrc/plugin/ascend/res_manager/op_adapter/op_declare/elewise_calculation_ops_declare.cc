...
#include "plugin/ascend/res_manager/op_adapter/op_declare/elewise_calculation_ops_declare.h"
#include <memory>
#include <string>
#include <vector>
#include "plugin/ascend/res_manager/op_adapter/custom_op_proto/cust_elewise_calculation_ops.h"
...
INPUT_ATTR_MAP(Cast) = {{2, ATTR_DESC(dst_type, AnyTraits<GEType>(), AnyTraits<int64_t>())}};
ATTR_MAP(Cast) = {{"dst_type", ATTR_DESC(dst_type, AnyTraits<GEType>(), AnyTraits<int64_t>())}};
