...
#include "plugin/ascend/kernel_executor/rts/hierarchical_memory/update_to_device.h"
...
namespace mindspore {
namespace kernel {
bool UpdateToDeviceKernel::Init(const AnfNodePtr &anf_node) {
...
bool UpdateToDeviceKernel::Launch(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &,
  ...
  return device::ascend::AscendUvmHal::GetInstance().UpdateRemoteToDevice(device_id_, device_ptr, inputs[0]->size(),
