 ...
 */
#include "plugin/ascend/graph_optimizer/pass/ir_fusion/padd_update_fusion.h"
#include <vector>
#include <memory>
#include <string>
#include <utility>
...
const AnfNodePtr PaddUpdateFusion::Process(const FuncGraphPtr &func_graph, const AnfNodePtr &node,
  ...
  tensor::TensorPtr const_tensor = tensor::from_spec(kInt64->type_id(), const_shape, device::DeviceType::kCPU);
