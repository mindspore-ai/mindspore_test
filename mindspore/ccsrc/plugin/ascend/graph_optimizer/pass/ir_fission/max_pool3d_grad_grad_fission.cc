 ...
 */
#include "plugin/ascend/graph_optimizer/pass/ir_fission/max_pool3d_grad_grad_fission.h"
#include <vector>
#include <memory>
#include <string>
...
tensor::TensorPtr CreateTensor(const AnfNodePtr &node) {
  ...
  tensor::TensorPtr assist_tensor = tensor::from_spec(kFloat16->type_id(), assist_shape, device::DeviceType::kCPU);
