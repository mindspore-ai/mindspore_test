 ...
 */
#include "plugin/ascend/graph_optimizer/pass/ir_fission/conv2d_backprop_filter_mul_fission.h"
#include <algorithm>
#include <string>
#include <vector>
#include <memory>
...
ValueNodePtr CreateAssistNode(const FuncGraphPtr &func_graph, const AnfNodePtr &node, const ShapeVector &shape,
  ...
  tensor::TensorPtr tensor = tensor::from_spec(type, shape, device::DeviceType::kCPU);
