...
#include "plugin/ascend/graph_optimizer/pass/ir_fission/tensor_scatter_fission.h"
...
#include "plugin/ascend/graph_optimizer/pass/ir_fusion/insert_depend_for_all_gather.h"
