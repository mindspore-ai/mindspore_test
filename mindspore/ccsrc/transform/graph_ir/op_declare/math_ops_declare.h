...
DECLARE_OP_ADAPTER(LpNormV2)
DECLARE_OP_USE_INPUT_ATTR(LpNormV2)
DECLARE_OP_USE_OUTPUT(LpNormV2)
...
DECLARE_CUST_OP_ADAPTER(HFFT)
DECLARE_CUST_OP_USE_OUTPUT(HFFT)

DECLARE_CUST_OP_ADAPTER(HFFT2)
DECLARE_CUST_OP_USE_OUTPUT(HFFT2)

DECLARE_CUST_OP_ADAPTER(HFFTN)
DECLARE_CUST_OP_USE_OUTPUT(HFFTN)

DECLARE_CUST_OP_ADAPTER(IHFFT)
DECLARE_CUST_OP_USE_OUTPUT(IHFFT)

DECLARE_CUST_OP_ADAPTER(IHFFT2)
DECLARE_CUST_OP_USE_OUTPUT(IHFFT2)

DECLARE_CUST_OP_ADAPTER(IHFFTN)
DECLARE_CUST_OP_USE_OUTPUT(IHFFTN)

DECLARE_CUST_OP_ADAPTER(FFTFreq)
DECLARE_CUST_OP_USE_OUTPUT(FFTFreq)

DECLARE_CUST_OP_ADAPTER(RFFTFreq)
DECLARE_CUST_OP_USE_OUTPUT(RFFTFreq)
...
DECLARE_CUST_OP_ADAPTER(RFFT2)
DECLARE_CUST_OP_USE_OUTPUT(RFFT2)

DECLARE_CUST_OP_ADAPTER(IRFFT2)
DECLARE_CUST_OP_USE_OUTPUT(IRFFT2)

DECLARE_CUST_OP_ADAPTER(RFFTN)
DECLARE_CUST_OP_USE_OUTPUT(RFFTN)

DECLARE_CUST_OP_ADAPTER(IRFFTN)
DECLARE_CUST_OP_USE_OUTPUT(IRFFTN)

DECLARE_CUST_OP_ADAPTER(IRFFTDouble)
DECLARE_CUST_OP_USE_OUTPUT(IRFFTDouble)

DECLARE_CUST_OP_ADAPTER(FFTOrtho)
DECLARE_CUST_OP_USE_OUTPUT(FFTOrtho)
...
DECLARE_CUST_OP_ADAPTER(IDCT)
DECLARE_CUST_OP_USE_OUTPUT(IDCT)

DECLARE_CUST_OP_ADAPTER(DCTN)
DECLARE_CUST_OP_USE_OUTPUT(DCTN)

DECLARE_CUST_OP_ADAPTER(IDCTN)
DECLARE_CUST_OP_USE_OUTPUT(IDCTN)
