 ...
 */
#ifndef MINDSPORE_CCSRC_FRONTEND_JIT_PI_STRATEGY_H
#define MINDSPORE_CCSRC_FRONTEND_JIT_PI_STRATEGY_H
...
class OptStrategy {
 public:
  ...
  static OptCodeSet MakeGuardListStrategyByFrame(const OptCodeSet &codes);
  static GuardItemVector MakeGuardItemListStrategyByFrame(const GuardItemVector &list);
};

}  // namespace pijit
}  // namespace mindspore

#endif  // MINDSPORE_CCSRC_FRONTEND_JIT_PI_STRATEGY_H
