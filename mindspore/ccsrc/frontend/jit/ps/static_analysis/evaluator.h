...
#ifndef MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_EVALUATOR_H_
#define MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_EVALUATOR_H_
...
#endif  // MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_EVALUATOR_H_
