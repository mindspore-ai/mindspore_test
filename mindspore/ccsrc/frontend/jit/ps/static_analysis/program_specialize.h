...
#ifndef MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_SPECIALIZE_H_
#define MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_SPECIALIZE_H_
...
#endif  // MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_SPECIALIZE_H_
