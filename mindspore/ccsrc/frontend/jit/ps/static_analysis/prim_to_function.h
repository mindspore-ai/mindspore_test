...
#ifndef MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_PRIM_TO_FUNCTION_H_
#define MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_PRIM_TO_FUNCTION_H_
...
#endif  // MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_PRIM_TO_FUNCTION_H_
