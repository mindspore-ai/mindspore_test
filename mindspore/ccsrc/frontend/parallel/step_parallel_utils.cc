...
void ConvertLayoutToStrategy(Dimensions *sub_strategy_vec, std::vector<std::string> alias_name,
                             std::vector<int64_t> device_matrix, std::vector<std::vector<int64_t>> tensor_map) {
