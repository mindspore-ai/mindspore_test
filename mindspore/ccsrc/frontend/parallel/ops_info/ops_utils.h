...
constexpr size_t CROSS_ENTROPY_LOSS_INPUTS_SIZE = 2;
constexpr size_t CROSS_ENTROPY_LOSS_INPUTS_WITH_WEIGHT_SIZE = 3;
constexpr size_t CROSS_ENTROPY_LOSS_OUTPUTS_SIZE = 4;
...
constexpr char PARAM_OUT_INDEX[] = "param_out_index";
constexpr char INDEX_OPERATOR_INFO[] = "index_operator_info";
...
constexpr char IGNORE_INDEX[] = "ignore_index";
constexpr char LABEL_SMOOTHING[] = "label_smoothing";
...
constexpr char FMOD_TENSOR[] = "FmodTensor";
constexpr char INPLACE_COPY[] = "InplaceCopy";
