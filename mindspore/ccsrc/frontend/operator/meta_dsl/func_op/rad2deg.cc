...
#include "mindspore/ccsrc/frontend/operator/meta_dsl/func_op/rad2deg.h"
...
BeginFunction(Rad2deg, input) {
  constexpr double M_180_PI = 57.295779513082320876798154814105170332405472466564;
  Return(Call(Prim(Muls), input, Value(std::make_shared<FP64Imm>(M_180_PI))));
}
EndFunction(Rad2deg)
}  // namespace mindspore::prim
