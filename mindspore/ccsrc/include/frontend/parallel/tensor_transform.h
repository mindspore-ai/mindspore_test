...
#ifndef MINDSPORE_CCSRC_INCLUDE_FRONTEND_PARALLEL_TENSOR_TRANSFORM_H_
#define MINDSPORE_CCSRC_INCLUDE_FRONTEND_PARALLEL_TENSOR_TRANSFORM_H_
...
#endif  // MINDSPORE_CCSRC_INCLUDE_FRONTEND_PARALLEL_TENSOR_TRANSFORM_H_
