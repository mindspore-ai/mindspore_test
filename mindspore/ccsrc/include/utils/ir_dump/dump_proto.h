 ...
 */
#ifndef MINDSPORE_CCSRC_INCLUDE_COMMON_IR_DUMP_PROTO_H_
#define MINDSPORE_CCSRC_INCLUDE_COMMON_IR_DUMP_PROTO_H_
...
#endif  // MINDSPORE_CCSRC_INCLUDE_COMMON_IR_DUMP_PROTO_H_
