...
#ifndef MINDSPORE_CCSRC_INCLUDE_BACKEND_COMMON_PASS_MANAGER_PATTERN_ENGINE_H_
#define MINDSPORE_CCSRC_INCLUDE_BACKEND_COMMON_PASS_MANAGER_PATTERN_ENGINE_H_
...
#endif  // MINDSPORE_CCSRC_INCLUDE_BACKEND_COMMON_PASS_MANAGER_PATTERN_ENGINE_H_
