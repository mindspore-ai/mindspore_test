...
namespace mindspore {
namespace device {
// Enhanced dynamic mem pool, support dry run, profiler, logging and memory tracker.
class BACKEND_EXPORT EnhancedDynamicMemPool : public AbstractDynamicMemPool {
 public:
  ~EnhancedDynamicMemPool() override = default;
...
#endif  // MINDSPORE_CCSRC_BACKEND_OPTIMIZER_MEM_REUSE_ENHANCED_DYNAMIC_MEM_POOL_H_
