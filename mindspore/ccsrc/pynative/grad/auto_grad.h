...
using MetaGradInfoList = OrderedMap<tensor::TensorPtr, AutoGradMetaDataPtr>;
...
class AutoGrad {
 public:
  ...
  virtual void CallCPPFunctionBprop(const ValuePtrList &flatten_outputs, const TensorPtrSet &input_base_tensors,
  ...
  virtual VariablePtr SafeGetVariableImpl(const tensor::TensorPtr &tensor) { return nullptr; }
