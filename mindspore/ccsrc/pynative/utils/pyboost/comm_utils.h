...
#ifndef MINDSPORE_MINDSPORE_CCSRC_KERNEL_PYBOOST_COMM_UTILS_H_
#define MINDSPORE_MINDSPORE_CCSRC_KERNEL_PYBOOST_COMM_UTILS_H_
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_KERNEL_PYBOOST_COMM_UTILS_H_
