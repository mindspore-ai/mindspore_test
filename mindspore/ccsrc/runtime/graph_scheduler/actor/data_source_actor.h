...
class DataSourceActor : public DebugAwareActor {
 ...
 protected:
  ...
  virtual void FillDataBuffer(OpContext<KernelTensor> *const context) = 0;
  ...
  std::vector<KernelTensorPtr> kernel_tensors_;
};
...
class DeviceQueueDataSourceActor : public DataSourceActor {
 ...
 protected:
  void Init() override;
  void FillDataBuffer(OpContext<KernelTensor> *const context);
...
class HostQueueDataSourceActor : public DataSourceActor {
 ...
 protected:
  void Init() override;
  void FillDataBuffer(OpContext<KernelTensor> *const context) override;
