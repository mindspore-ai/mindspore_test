...
class CallbackImpl : public Callback {
 public:
  ...
  void ResetKernelInfoInputs(const AnfNodePtr &node, const std::vector<size_t> &indices) override;
...
class CallbackImplWithInferShape : public CallbackImpl {
 public:
  ShapeVector GetInputShape(const AnfNodePtr &node, size_t i) override;
  ShapeVector GetOutputShape(const AnfNodePtr &node, size_t i) override;
  TypeId GetInputType(const AnfNodePtr &node, size_t i) override;
  ...
  void ResetKernelInfoInputs(const AnfNodePtr &, const std::vector<size_t> &) override {}
};
}  // namespace mindspore::graphkernel
