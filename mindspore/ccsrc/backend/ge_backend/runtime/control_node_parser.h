...
#ifndef MINDSPORE_CCSRC_BACKEND_GEBACKEND_RUNTIME_CONTROL_NODE_PARSER_H_
#define MINDSPORE_CCSRC_BACKEND_GEBACKEND_RUNTIME_CONTROL_NODE_PARSER_H_
...
#endif  // MINDSPORE_CCSRC_BACKEND_GEBACKEND_RUNTIME_CONTROL_NODE_PARSER_H_
