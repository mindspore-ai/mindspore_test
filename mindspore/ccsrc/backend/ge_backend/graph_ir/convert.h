...
#ifndef MINDSPORE_CCSRC_BACKEND_GE_BACKEND_GRAPH_IR_CONVERT_H_
#define MINDSPORE_CCSRC_BACKEND_GE_BACKEND_GRAPH_IR_CONVERT_H_
...
#endif  // MINDSPORE_CCSRC_BACKEND_GE_BACKEND_GRAPH_IR_CONVERT_H_
