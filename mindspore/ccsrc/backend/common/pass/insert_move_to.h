 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_OPTIMIZER_PASS_INSERT_MOVE_TO_H_
#define MINDSPORE_CCSRC_BACKEND_OPTIMIZER_PASS_INSERT_MOVE_TO_H_
...
class BACKEND_EXPORT InsertMoveTo : public Pass {
 ...
 private:
  ...
  bool auto_offload_{false};
  std::string offload_parameter_;
};
}  // namespace opt
}  // namespace mindspore

#endif  // MINDSPORE_CCSRC_BACKEND_OPTIMIZER_PASS_INSERT_MOVE_TO_H_
