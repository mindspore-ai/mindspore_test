...
#include "minddata/dataset/audio/transform/validators.h"
#include "minddata/dataset/vision/kernels/erase_op.h"
#if defined(ENABLE_D)
#include "minddata/dataset/vision/kernels/dvpp/ascend910b/dvpp_erase_op.h"
#endif
