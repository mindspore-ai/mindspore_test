...
namespace mindspore {
namespace ops {
class MIND_API GroupedMatmulFuncImpl : public OpFuncImpl {
 public:
 ...
 private:
  void CheckSplitItem(const std::string &op_name, const int64_t split_mode) const;
  void CheckGroupType(const std::string &op_name, const int64_t group_type) const;
