        ...
        Args:
            file_path(Union[str, None]): The path to the parallel speed up json file, configuration can refer to
                ...
                - computation_communication_fusion_level (int): Enable the fusion between compute and communicate.
                  ...
                  .. warning::
                    When enabling the fusion of computation and communication, if you also set
                    ``export MS_ENABLE_LCCL=true``, the MTE-based fusion operator will be used. In some scenarios,
                    this may lead to greater performance gains. Please note that this operator is still in an
                    experimental stage and may be changed or removed in the future.
