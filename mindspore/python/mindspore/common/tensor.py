...
class Tensor(TensorPy_, metaclass=_TensorMeta):
    ...
    def init_data(self, slice_index=None, shape=None, opt_shard_group=None):
        ...
        Args:
            ...
            opt_shard_group(str): Optimizer shard group which is used in auto or semi auto parallel mode
                ...
                `Optimizer Parallel
                <https://www.mindspore.cn/docs/en/master/features/parallel/optimizer_parallel.html>`_.
                Default: ``None``.
    ...
    def move_to(self, to, blocking=True):
        ...
        return Tensor(TensorPy_.move_to(self, to, blocking), device="CPU" if to == "CPU" else None)
