    ...
    Args:
        config(dict): When initializing AscendCL, you can enable or configure the
            ...
            - ``"err_msg_mode"``: This parameter is used to control the level at which error information is retrieved,
              either by process or by thread. The default level is by thread. "0" is the default value, indicating
              that error information is retrieved at the thread level.
              "1" indicates that error information is retrieved at the process level.
