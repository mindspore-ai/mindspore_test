...
public:
    ...
    py::object GetDistributedOp(const std::string& op_name) {
        ...
        auto get_distributed_op = py::module_::import("mindspore.parallel.ops.parallel_layout")
...
PYBOOST_API_BODY_WITH_LAYOUT_CC_TEMPLATE = Template("""
