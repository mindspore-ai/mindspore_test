...
int FixedBitWeightQuantizationWithHolder::QuantFilter(const AnfNodePtr &parameter_node, const tensor::TensorPtr &weight,
                                                      const PrimitivePtr &primitive, quant::QuantType quant_type,
                                                      int quant_max, int quant_min, size_t bit_num,
                                                      WeightQuantType weight_quant_type, TypeId quant_data_type,
                                                      int index, int preferred_dim, bool symmetric, bool narrow_range,
...
int FixedBitWeightQuantizationWithHolder::StatisticsFilter(const tensor::TensorPtr &weight,
                                                           const PrimitivePtr &primitive, quant::QuantType quant_type,
                                                           int quant_max, int quant_min, size_t bit_num,
                                                           WeightQuantType weight_quant_type, TypeId quant_data_type,
                                                           int index, int preferred_dim, bool symmetric,
                                                           bool narrow_range) {
...
int FixedBitWeightQuantizationWithHolder::QuantBias(const ParameterPtr &bias, const PrimitivePtr &primitive) {
...
int FixedBitWeightQuantizationWithHolder::ComputeBiasDataAndQuantParam(const std::vector<double> &bias_scales,
