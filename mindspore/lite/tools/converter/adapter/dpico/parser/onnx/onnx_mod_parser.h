...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_PARSER_ONNX_ONNX_MOD_PARSER_H_
...
class OnnxModParser : public converter::NodeParser {
 public:
  OnnxModParser() : NodeParser() {}
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_PARSER_ONNX_ONNX_MOD_PARSER_H_
