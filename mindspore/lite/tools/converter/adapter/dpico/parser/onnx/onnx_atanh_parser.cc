...
namespace mindspore {
namespace lite {
ops::BaseOperatorPtr OnnxAtanhParser::Parse(const onnx::GraphProto &onnx_proto, const onnx::NodeProto &onnx_node) {
...
REG_NODE_PARSER(kFmkTypeOnnx, Atanh, std::make_shared<lite::OnnxAtanhParser>())
}  // namespace mindspore::registry
