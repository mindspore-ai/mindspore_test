...
namespace mindspore {
namespace lite {
ops::BaseOperatorPtr OnnxXorParser::Parse(const onnx::GraphProto &onnx_proto, const onnx::NodeProto &onnx_node) {
...
REG_NODE_PARSER(kFmkTypeOnnx, Xor, std::make_shared<lite::OnnxXorParser>())
}  // namespace mindspore::registry
