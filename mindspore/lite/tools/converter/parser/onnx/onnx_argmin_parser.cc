...
namespace mindspore {
namespace lite {
PrimitiveCPtr OnnxArgMinParser::Parse(const onnx::GraphProto &onnx_graph, const onnx::NodeProto &onnx_node) {
...
OnnxNodeRegistrar g_onnxArgMinParser("ArgMin", new OnnxArgMinParser());
}  // namespace lite
}  // namespace mindspore
