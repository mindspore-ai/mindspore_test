...
namespace mindspore {
namespace lite {
PrimitiveCPtr PytorchLogSoftmaxParser::Parse(const torch::jit::Node *torch_node, std::vector<size_t> *input_indices) {
...
PytorchNodeRegistrar g_pytorchLoftSoftmaxParser("log_softmax", new PytorchLogSoftmaxParser());
}  // namespace lite
}  // namespace mindspore
