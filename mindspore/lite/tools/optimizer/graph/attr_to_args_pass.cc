...
static const std::map<std::string, std::vector<std::pair<std::string, size_t>>> kAttrMapNeedAdjust = {
  {"PadV3", {{"mode", 4}, {"paddings_contiguous", 5}}},
  {"SparseApplyCenteredRMSProp", {{"use_locking", 11}}},
  {"ApplyKerasMomentum", {{"use_locking", 6}, {"use_nesterov", 7}}},
  {"ApplyFtrl", {{"use_locking", 9}}},
  {"ApplyAdagrad", {{"update_slots", 5}}},
  {"ApplyAdagradV2", {{"epsilon", 5}, {"update_slots", 6}}},
  {"ApplyAdagradDA", {{"use_locking", 9}}},
  {"LARSUpdate", {{"epsilon", 7}, {"hyperpara", 8}, {"use_clip", 9}}},
  {"SparseApplyAdagradDA", {{"use_locking", 10}}},
  {"SparseApplyMomentum", {{"use_locking", 7}, {"use_nesterov", 8}}},
  {"SparseApplyProximalGradientDescent", {{"use_locking", 7}}},
  {"ApplyAdamWithAmsgrad", {{"beta1", 9}, {"beta2", 10}, {"epsilon", 11}, {"use_locking", 12}}},
  {"ApplyAdamWithAmsgradV2", {{"use_locking", 12}}},
  {"Adam", {{"use_locking", 11}, {"use_nesterov", 12}}},
  {"SparseApplyRMSProp", {{"rho", 7}, {"momentum", 8}, {"epsilon", 9}, {"use_locking", 10}}},
