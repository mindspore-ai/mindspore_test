 ...
 */
#ifndef MINDSPORE_CCSRC_MINDDATA_DATASET_UTIL_AUTO_INDEX_H_
...
#include "mindspore/lite/minddata/dataset/util/btree.h"
#include "mindspore/lite/minddata/dataset/util/system_pool.h"
