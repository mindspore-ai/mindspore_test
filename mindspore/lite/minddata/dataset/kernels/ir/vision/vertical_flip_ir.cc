...
#include "mindspore/lite/minddata/dataset/kernels/image/vertical_flip_op.h"
#endif
#if !defined(BUILD_LITE) && defined(ENABLE_D)
#include "mindspore/lite/minddata/dataset/kernels/image/dvpp/ascend910b/dvpp_vertical_flip_op.h"
#endif
