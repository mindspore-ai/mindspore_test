...
#ifndef MINDSPORE_CCSRC_MINDDATA_DATASET_KERNELS_IR_VISION_RAND_AUGMENT_IR_H_
#define MINDSPORE_CCSRC_MINDDATA_DATASET_KERNELS_IR_VISION_RAND_AUGMENT_IR_H_
...
#include "mindspore/lite/minddata/dataset/kernels/image/rand_augment_op.h"
