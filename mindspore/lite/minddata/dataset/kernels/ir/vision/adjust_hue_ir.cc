...
#include "mindspore/lite/minddata/dataset/kernels/image/adjust_hue_op.h"
#endif
#if !defined(BUILD_LITE) && defined(ENABLE_D)
#include "mindspore/lite/minddata/dataset/kernels/image/dvpp/ascend910b/dvpp_adjust_hue_op.h"
#endif
