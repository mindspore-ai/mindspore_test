...
#include "mindspore/lite/minddata/dataset/kernels/image/normalize_op.h"
#if !defined(BUILD_LITE) && defined(ENABLE_D)
#include "mindspore/lite/minddata/dataset/kernels/image/dvpp/ascend910b/dvpp_normalize_v2_op.h"
#endif
