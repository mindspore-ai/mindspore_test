...
#include "mindspore/lite/minddata/dataset/kernels/image/dvpp/utils/AclLiteError.h"
#include "mindspore/lite/minddata/dataset/kernels/image/dvpp/utils/AclLiteType.h"
