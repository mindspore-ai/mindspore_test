...
#ifndef MINDSPORE_CORE_OPS_TENSOR_REPORT_H_
#define MINDSPORE_CORE_OPS_TENSOR_REPORT_H_
#include <map>
#include <memory>
#include <string>
...
class TensorReport : public BaseOperator {
 public:
  ...
  TensorReport() : BaseOperator(kNameTensorReport) {}
  void Init();
...
#endif  // MINDSPORE_CORE_OPS_TENSOR_REPORT_H_
