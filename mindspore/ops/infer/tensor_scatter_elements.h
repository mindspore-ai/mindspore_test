...
class OPS_API TensorScatterElements : public BaseOperator {
 public:
  ...
  void Init(const int64_t axis = 0, const std::string reduction = "none");
  /// \brief Set axis.
...
OPS_API abstract::AbstractBasePtr TensorScatterElementsInfer(const abstract::AnalysisEnginePtr &,
