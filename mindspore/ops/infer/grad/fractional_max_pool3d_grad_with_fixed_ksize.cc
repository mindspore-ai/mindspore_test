...
#include "infer/grad/fractional_max_pool3d_grad_with_fixed_ksize.h"
...
class OPS_API AGFractionalMaxPool3DGradWithFixedKsizeInfer : public abstract::OpInferBase {
 public:
