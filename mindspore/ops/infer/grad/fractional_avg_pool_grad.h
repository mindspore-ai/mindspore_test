...
#ifndef MINDSPORE_CORE_OPS_FRACTIONAL_AVG_POOL_GRAD_H_
#define MINDSPORE_CORE_OPS_FRACTIONAL_AVG_POOL_GRAD_H_
#include <map>
#include <memory>
#include <set>
#include <string>
...
#endif  // MINDSPORE_CORE_OPS_FRACTIONAL_AVG_POOL_GRAD_H_
