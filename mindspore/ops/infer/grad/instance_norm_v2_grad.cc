...
#include "infer/grad/instance_norm_v2_grad.h"
...
abstract::TupleShapePtr InstanceNormV2GradInferShape(const PrimitivePtr &primitive,
  ...
  constexpr pyfloat epsilon_min = 0.0;
  constexpr pyfloat epsilon_max = 1.0;
...
class OPS_API AGInstanceNormV2GradInfer : public abstract::OpInferBase {
 public:
