 ...
 */
#ifndef MINDSPORE_CORE_OPS_FUSION_GeGluV2_H_
#define MINDSPORE_CORE_OPS_FUSION_GeGluV2_H_
#include <memory>
#include <vector>
...
class GeGluV2 : public BaseOperator {
 public:
  ...
  /// \brief Constructor.
  GeGluV2() : BaseOperator(kNameGeGluV2) { InitIOName({"x"}, {"y", "gelu"}); }
...
#endif  // MINDSPORE_CORE_OPS_FUSION_GeGluV2_H_
