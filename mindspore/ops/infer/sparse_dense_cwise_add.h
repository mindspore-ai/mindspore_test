...
#ifndef MINDSPORE_CORE_OPS_SPARSE_DENSE_CWISE_ADD_H_
#define MINDSPORE_CORE_OPS_SPARSE_DENSE_CWISE_ADD_H_
#include <memory>
#include <vector>
...
#endif  // MINDSPORE_CORE_OPS_SPARSE_DENSE_CWISE_ADD_H_
