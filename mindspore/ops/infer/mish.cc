...
namespace ops {
namespace {
abstract::BaseShapePtr MishInferShape(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) {
...
class OPS_API AGMishInfer : public abstract::OpInferBase {
 public:
