...
#include "infer/embedding_compute_var_import.h"
...
#include "infer/ops_func_impl/embedding_compute_var_import.h"

namespace mindspore {
namespace ops {
MIND_API_OPERATOR_IMPL(EmbeddingComputeVarImport, BaseOperator);
class OPS_API EmbeddingComputeVarImportInfer : public abstract::OpInferBase {
 public:
