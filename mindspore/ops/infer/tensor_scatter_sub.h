...
#ifndef MINDSPORE_CORE_OPS_TENSOR_SCATTER_SUB_H_
#define MINDSPORE_CORE_OPS_TENSOR_SCATTER_SUB_H_
#include <memory>
#include <vector>
...
class TensorScatterSub : public BaseOperator {
 public:
  ...
  /// \brief Constructor.
  TensorScatterSub() : BaseOperator(kNameTensorScatterSub) { InitIOName({"input_x", "indices", "updates"}, {"y"}); }
};

using kPrimTensorScatterSubPtr = std::shared_ptr<TensorScatterSub>;
}  // namespace ops
}  // namespace mindspore

#endif  // MINDSPORE_CORE_OPS_TENSOR_SCATTER_SUB_H_
