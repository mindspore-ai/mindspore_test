...
#include "infer/sparse_sparse_arithmetic.h"
#include "infer/sparse_sparse_minimum.h"
#include "infer/sparse_sparse_maximum.h"
...
class OPS_API AGSparseSparseArithmeticInfer : public abstract::OpInferBase {
 public:
