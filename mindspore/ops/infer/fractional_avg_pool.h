...
#ifndef MINDSPORE_CORE_OPS_FRACTIONAL_AVG_POOL_H_
#define MINDSPORE_CORE_OPS_FRACTIONAL_AVG_POOL_H_
#include <map>
#include <memory>
#include <string>
#include <vector>
...
class FractionalAvgPool : public BaseOperator {
 public:
  ...
  /// \brief Init. Refer to the parameters of Python API @ref mindspore.ops.FractionalAvgPool for the inputs.
...
#endif  // MINDSPORE_CORE_OPS_FRACTIONAL_AVG_POOL_H_
