 ...
 */
#ifndef MINDSPORE_CORE_OPS_CTC_GREEDY_DECODER_H_
#define MINDSPORE_CORE_OPS_CTC_GREEDY_DECODER_H_
...
class CTCGreedyDecoder : public BaseOperator {
 public:
  ...
  CTCGreedyDecoder() : BaseOperator(kNameCTCGreedyDecoder) {
    InitIOName({"inputs_x", "sequence_length"},
               {"decoded_indices", "decoded_values", "decoded_shape", "log_probability"});
  }

  void Init(const bool merge_repeated = true);
...
#endif  // MINDSPORE_CORE_OPS_CTC_GREEDY_DECODER_H_
