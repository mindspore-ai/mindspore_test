 ...
 */
#include "infer/map_tensor_get_grad.h"
...
AbstractBasePtr MapTensorGetGradInferInner(const PrimitivePtr &primitive,
  ...
  auto abs_map_tensor =
    CheckAndConvertUtils::CheckArgsType(kNameMapTensorGetGrad, input_args, kInputIndex0, kObjectTypeMapTensorType);
...
class OPS_API AGMapTensorGetGradInfer : public abstract::OpInferBase {
 public:
