...
#include "infer/layer_norm_beta_gamma_backprop_v2.h"
...
TypePtr LayerNormBetaGammaBackpropV2InferType(const PrimitivePtr &prim,
  ...
  std::set<TypePtr> valid_types = {kFloat16, kBFloat16, kFloat32};
  auto output_type =
...
class OPS_API AGLayerNormBetaGammaBackpropV2Infer : public abstract::OpInferBase {
 public:
