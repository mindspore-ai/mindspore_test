...
#include "infer/unsorted_segment_max.h"
#include "infer/unsorted_segment_min.h"
#include "infer/unsorted_segment_prod.h"
...
class OPS_API AGUnsortedSegmentArithmeticInfer : public abstract::OpInferBase {
 public:
