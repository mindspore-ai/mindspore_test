...
#include <set>
#include "infer/ops_func_impl/new_empty.h"
#include "mindspore/ops/ops_utils/op_utils.h"
#include "utils/check_convert_utils.h"

namespace mindspore::ops {
ShapeArray NewEmptyFuncImpl::InferShape(const PrimitivePtr &primitive, const InferInfoPtrList &input_infos) const {
...
std::vector<TypeId> NewEmptyFuncImpl::InferType(const PrimitivePtr &primitive,
