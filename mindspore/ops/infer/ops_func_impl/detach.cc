...
namespace mindspore {
namespace ops {
BaseShapePtr DetachFuncImpl::InferShape(const PrimitivePtr &primitive,
...
TypePtr DetachFuncImpl::InferType(const PrimitivePtr &prim, const std::vector<AbstractBasePtr> &input_args) const {
  constexpr size_t data_index = 0;
  MS_EXCEPTION_IF_NULL(input_args[data_index]);
