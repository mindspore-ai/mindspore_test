...
#ifndef MINDSPORE_OPS_INFER_OPS_FUNC_IMPL_EXPM1_H_
#define MINDSPORE_OPS_INFER_OPS_FUNC_IMPL_EXPM1_H_
#include <memory>
#include <vector>
...
namespace mindspore {
namespace ops {
class Expm1FuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_OPS_INFER_OPS_FUNC_IMPL_EXPM1_H_
