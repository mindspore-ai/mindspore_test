...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_MSE_LOSS_EXT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_MSE_LOSS_EXT_H_
...
class OPS_API MSELossExtFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_MSE_LOSS_EXT_H_
