...
#include "infer/ops_func_impl/dist_comm_scatter_tensor.h"
#include <memory>
#include <set>
#include <string>
...
namespace mindspore {
namespace ops {
ShapeArray DistCommScatterTensorFuncImpl::InferShape(const PrimitivePtr &primitive,
...
std::vector<TypeId> DistCommScatterTensorFuncImpl::InferType(const PrimitivePtr &primitive,
                                                             const InferInfoPtrList &input_infos) const {
