...
#include "infer/ops_func_impl/apply_rms_prop.h"
...
namespace mindspore {
namespace ops {
BaseShapePtr ApplyRMSPropFuncImpl::InferShape(const PrimitivePtr &primitive,
...
TypePtr ApplyRMSPropFuncImpl::InferType(const PrimitivePtr &primitive,
                                        const std::vector<AbstractBasePtr> &input_args) const {
  MS_EXCEPTION_IF_NULL(primitive);
