 ...
 */
#ifndef MINDSPORE_OPS_INFER_OPS_FUNC_IMPL_MISH_EXT_H_
#define MINDSPORE_OPS_INFER_OPS_FUNC_IMPL_MISH_EXT_H_
...
#endif  // MINDSPORE_OPS_INFER_OPS_FUNC_IMPL_MISH_EXT_H_
