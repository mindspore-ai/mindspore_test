...
#include "infer/ops_func_impl/empty.h"
#include <vector>
...
namespace mindspore {
namespace ops {
ShapeArray EmptyFuncImpl::InferShape(const PrimitivePtr &primitive, const InferInfoPtrList &input_infos) const {
...
std::vector<TypeId> EmptyFuncImpl::InferType(const PrimitivePtr &primitive, const InferInfoPtrList &input_infos) const {
  ...
  // return float32 if dtype_info is none
