...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SOFTPLUSEXT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SOFTPLUSEXT_H_
...
namespace mindspore {
namespace ops {
class OPS_API SoftplusExtFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SOFTPLUSEXT_H_
