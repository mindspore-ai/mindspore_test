...
#include "infer/ops_func_impl/apply_ada_max.h"
...
namespace ops {
namespace {
BaseShapePtr ApplyAdaMaxInferShape(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) {
...
TuplePtr ApplyAdaMaxInferType(const PrimitivePtr &prim, const std::vector<AbstractBasePtr> &input_args) {
  ...
  (void)CheckAndConvertUtils::CheckTensorTypeSame(args_beta1_power, valid_types, prim_name);
  (void)CheckAndConvertUtils::CheckTensorTypeSame(args_lr, valid_types, prim_name);
  (void)CheckAndConvertUtils::CheckTensorTypeSame(args_beta1, valid_types, prim_name);
  (void)CheckAndConvertUtils::CheckTensorTypeSame(args_beta2, valid_types, prim_name);
...
BaseShapePtr ApplyAdaMaxFuncImpl::InferShape(const PrimitivePtr &primitive,
                                             const std::vector<AbstractBasePtr> &input_args) const {
  return ApplyAdaMaxInferShape(primitive, input_args);
}

TypePtr ApplyAdaMaxFuncImpl::InferType(const PrimitivePtr &primitive,
                                       const std::vector<AbstractBasePtr> &input_args) const {
