...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ARGMAX_EXT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ARGMAX_EXT_H_
...
namespace mindspore {
namespace ops {
class OPS_API ArgMaxExtFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ARGMAX_EXT_H_
