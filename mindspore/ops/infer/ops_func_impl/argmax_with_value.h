...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ARGMAX_WITH_VALUE_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ARGMAX_WITH_VALUE_H_
...
namespace mindspore {
namespace ops {
class OPS_API ArgMaxWithValueFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ARGMAX_WITH_VALUE_H_
