...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SIN_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SIN_H_

#include <vector>
#include "mindspore/core/ops/ops_func_impl/op_func_impl.h"

namespace mindspore::ops {
/// \brief Implementation of InferShape and InferType functions for operator 'Sin'
class OPS_API SinFuncImpl : public OpFuncImpl {
 public:
