...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_GELU_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_GELU_H_
...
namespace mindspore {
namespace ops {
class OPS_API GeLUFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_GELU_H_
