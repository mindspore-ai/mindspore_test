...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SELECTV2_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SELECTV2_H_
...
namespace mindspore {
namespace ops {
class SelectV2FuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SELECTV2_H_
