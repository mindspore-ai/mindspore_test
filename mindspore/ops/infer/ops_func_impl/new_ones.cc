...
#include <set>
#include "infer/ops_func_impl/new_ones.h"
#include "mindspore/ops/ops_utils/op_utils.h"
#include "utils/check_convert_utils.h"

namespace mindspore::ops {
ShapeArray NewOnesFuncImpl::InferShape(const PrimitivePtr &primitive, const InferInfoPtrList &input_infos) const {
...
std::vector<TypeId> NewOnesFuncImpl::InferType(const PrimitivePtr &primitive,
