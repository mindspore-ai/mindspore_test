...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SOFTSHRINK_GRAD_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SOFTSHRINK_GRAD_H_
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SOFTSHRINK_GRAD_H_
