...
#ifndef MINDSPORE_CORE_OPS_INPLACE_ADDMM_H_
#define MINDSPORE_CORE_OPS_INPLACE_ADDMM_H_
...
namespace mindspore {
namespace ops {
class InplaceAddmmFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_INPLACE_ADDMM_H_
