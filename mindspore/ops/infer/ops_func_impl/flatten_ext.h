...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_FLATTEN_EXT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_FLATTEN_EXT_H_
#include <memory>
#include <vector>
...
namespace mindspore {
namespace ops {
class OPS_API FlattenExtFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_FLATTEN_EXT_H_
