...
#include "infer/ops_func_impl/sparse_apply_centered_rms_prop.h"
...
namespace ops {
namespace {
BaseShapePtr SparseApplyCenteredRMSPropInferShape(const PrimitivePtr &primitive,
...
BaseShapePtr SparseApplyCenteredRMSPropFuncImpl::InferShape(const PrimitivePtr &primitive,
                                                            const std::vector<AbstractBasePtr> &input_args) const {
  return SparseApplyCenteredRMSPropInferShape(primitive, input_args);
}

TypePtr SparseApplyCenteredRMSPropFuncImpl::InferType(const PrimitivePtr &primitive,
                                                      const std::vector<AbstractBasePtr> &input_args) const {
