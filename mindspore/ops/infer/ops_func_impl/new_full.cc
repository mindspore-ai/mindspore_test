...
#include "infer/ops_func_impl/new_full.h"
#include <memory>
#include <vector>
...
ShapeArray NewFullFuncImpl::InferShape(const PrimitivePtr &primitive, const InferInfoPtrList &input_infos) const {
...
std::vector<TypeId> NewFullFuncImpl::InferType(const PrimitivePtr &primitive,
