 ...
 */
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_COL2IM_EXT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_COL2IM_EXT_H_
...
namespace mindspore {
namespace ops {
class OPS_API Col2ImExtFuncImpl final : public OpFuncImpl {
 public:
 ...
 private:
  const size_t no_batch_rank_ = 2;
  const size_t batch_rank_ = 3;
};
}  // namespace ops
}  // namespace mindspore
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_COL2IM_EXT_H_
