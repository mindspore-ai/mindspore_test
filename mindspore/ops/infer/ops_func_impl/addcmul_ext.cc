...
#include "infer/ops_func_impl/addcmul_ext.h"
#include <string>
...
namespace mindspore {
namespace ops {
ShapeArray AddcmulExtFuncImpl::InferShape(const PrimitivePtr &primitive, const InferInfoPtrList &input_infos) const {
...
std::vector<TypeId> AddcmulExtFuncImpl::InferType(const PrimitivePtr &primitive,
