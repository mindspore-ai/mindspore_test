...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ATAN2_EXT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ATAN2_EXT_H_
...
namespace mindspore {
namespace ops {
class OPS_API Atan2ExtFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ATAN2_EXT_H_
