 ...
 */
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_TRIL_EXT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_TRIL_EXT_H_
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_TRIL_EXT_H_
