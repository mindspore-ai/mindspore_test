...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_WEIGHT_QUANT_BATCH_MATMUL_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_WEIGHT_QUANT_BATCH_MATMUL_H_
...
namespace mindspore {
namespace ops {
class OPS_API WeightQuantBatchMatmulFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_WEIGHT_QUANT_BATCH_MATMUL_H_
