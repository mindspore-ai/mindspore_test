...
#include "infer/ops_func_impl/layer_norm_grad_v3.h"
...
namespace mindspore {
namespace ops {
BaseShapePtr LayerNormGradV3FuncImpl::InferShape(const PrimitivePtr &primitive,
...
TypePtr LayerNormGradV3FuncImpl::InferType(const PrimitivePtr &primitive,
                                           const std::vector<AbstractBasePtr> &input_args) const {
