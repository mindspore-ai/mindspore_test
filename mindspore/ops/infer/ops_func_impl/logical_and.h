...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LOGICAL_AND_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LOGICAL_AND_H_
...
namespace mindspore {
namespace ops {
class OPS_API LogicalAndFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LOGICAL_AND_H_
