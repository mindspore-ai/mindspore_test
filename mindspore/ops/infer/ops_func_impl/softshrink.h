...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SOFTSHRINK_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SOFTSHRINK_H_
...
namespace mindspore {
namespace ops {
class OPS_API SoftShrinkFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_SOFTSHRINK_H_
