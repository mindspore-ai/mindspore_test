...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_FILL_TENSOR_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_FILL_TENSOR_H_
...
namespace mindspore {
namespace ops {
class OPS_API FillTensorFuncImpl : public FillFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_FILL_TENSOR_H_
