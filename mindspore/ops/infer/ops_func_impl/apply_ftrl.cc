...
#include "infer/ops_func_impl/apply_ftrl.h"
...
namespace mindspore {
namespace ops {
BaseShapePtr ApplyFtrlFuncImpl::InferShape(const PrimitivePtr &primitive,
  ...
  auto accum_shape_map = CheckAndConvertUtils::ConvertShapePtrToShapeMap(input_args[kInputIndex1]->GetShape())[kShape];
  auto linear_shape_map = CheckAndConvertUtils::ConvertShapePtrToShapeMap(input_args[kInputIndex2]->GetShape())[kShape];
  ...
  (void)CheckAndConvertUtils::CheckInteger("lr_shape size", SizeToLong(lr_shape_map.size()), kGreaterEqual, batch_rank,
                                           prim_name);
  (void)CheckAndConvertUtils::CheckInteger("l1_shape size", SizeToLong(l1_shape_map.size()), kGreaterEqual, batch_rank,
                                           prim_name);
  (void)CheckAndConvertUtils::CheckInteger("l2_shape size", SizeToLong(l2_shape_map.size()), kGreaterEqual, batch_rank,
                                           prim_name);
  (void)CheckAndConvertUtils::CheckInteger("lr_power_shape size", SizeToLong(lr_power_shape_map.size()), kGreaterEqual,
...
TypePtr ApplyFtrlFuncImpl::InferType(const PrimitivePtr &prim, const std::vector<AbstractBasePtr> &input_args) const {
