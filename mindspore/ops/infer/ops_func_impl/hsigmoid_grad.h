 ...
 */
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSIGMOID_GRAD_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSIGMOID_GRAD_H_
...
namespace mindspore {
namespace ops {
class OPS_API HSigmoidGradFuncImpl : public OpFuncImpl {
 public:
  HSigmoidGradFuncImpl() = default;
  ~HSigmoidGradFuncImpl() = default;
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSIGMOID_GRAD_H_
