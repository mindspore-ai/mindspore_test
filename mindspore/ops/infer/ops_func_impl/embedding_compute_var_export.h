...
namespace mindspore {
namespace ops {
class OPS_API EmbeddingComputeVarExportFuncImpl final : public EmbeddingComputeVarFuncImpl {};
}  // namespace ops
}  // namespace mindspore

#endif  // MINDSPORE_CORE_OPS_FUNC_IMPL_EMBEDDING_COMPUTE_VAR_EXPORT_H_
