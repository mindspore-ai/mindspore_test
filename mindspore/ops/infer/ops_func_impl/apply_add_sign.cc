...
#include "infer/ops_func_impl/apply_add_sign.h"
...
namespace ops {
namespace {
BaseShapePtr ApplyAddSignInferShape(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) {
...
TypePtr ApplyAddSignInferType(const PrimitivePtr &prim, const std::vector<AbstractBasePtr> &input_args) {
...
BaseShapePtr ApplyAddSignFuncImpl::InferShape(const PrimitivePtr &primitive,
                                              const std::vector<AbstractBasePtr> &input_args) const {
  return ApplyAddSignInferShape(primitive, input_args);
}

TypePtr ApplyAddSignFuncImpl::InferType(const PrimitivePtr &primitive,
                                        const std::vector<AbstractBasePtr> &input_args) const {
