...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_AVG_POOL2D_GRAD_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_AVG_POOL2D_GRAD_H_
...
namespace mindspore {
namespace ops {
class OPS_API AvgPool2DGradFuncImpl final : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_AVG_POOL2D_GRAD_H_
