...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_MOE_GATING_GROUP_TOPK_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_MOE_GATING_GROUP_TOPK_H_
#include <algorithm>
#include <map>
#include <memory>
#include <set>
...
namespace mindspore {
namespace ops {
enum MoeGatingGroupTopKInputIndex : size_t {
...
enum MoeGatingGroupTopKOutputIndex : size_t {
...
class OPS_API MoeGatingGroupTopKFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_MOE_GATING_GROUP_TOPK_H_
