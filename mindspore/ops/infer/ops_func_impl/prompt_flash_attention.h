 ...
 */
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_PROMPT_FLASH_ATTENTION_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_PROMPT_FLASH_ATTENTION_H_
...
enum PromptFlashAttentionInputIndex : size_t {
  ...
  kPromptFlashAttentionInputLayoutIndex,
  kPromptFlashAttentionInputNumKeyValueHeadsIndex,
  kPromptFlashAttentionInputSparseModeIndex,
  kPromptFlashAttentionInputInnerPreciseIndex,
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_PROMPT_FLASH_ATTENTION_H_
