...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_APPLY_ROTARY_POS_EMB_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_APPLY_ROTARY_POS_EMB_H_
#include <map>
#include <vector>
#include <memory>
...
enum ApplyRotaryPosEmbQueryOutputIndex : size_t {
  kApplyRotaryPosEmbQueryEmbedIndex = 0,
  kApplyRotaryPosEmbKeyEmbedIndex,
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_APPLY_ROTARY_POS_EMB_H_
