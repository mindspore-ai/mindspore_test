 ...
 */
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_IM2COL_EXT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_IM2COL_EXT_H_
...
namespace mindspore {
namespace ops {
class OPS_API Im2ColExtFuncImpl : public OpFuncImpl {
 public:
 ...
 protected:
  size_t no_batch_rank_ = 4;
  size_t batch_rank_ = 4;
};
}  // namespace ops
}  // namespace mindspore
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_IM2COL_EXT_H_
