...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_GREATER_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_GREATER_H_
...
namespace mindspore {
namespace ops {
class OPS_API GreaterFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_GREATER_H_
