...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LOGICAL_NOT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LOGICAL_NOT_H_
...
namespace mindspore {
namespace ops {
class OPS_API LogicalNotFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LOGICAL_NOT_H_
