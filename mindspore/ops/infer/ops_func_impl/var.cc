 ...
 */
#include "infer/ops_func_impl/var.h"
#include <set>
#include <memory>
#include <vector>
...
namespace mindspore {
namespace ops {
ShapeArray VarFuncImpl::InferShape(const PrimitivePtr &primitive, const InferInfoPtrList &input_infos) const {
...
std::vector<TypeId> VarFuncImpl::InferType(const PrimitivePtr &primitive, const InferInfoPtrList &input_infos) const {
