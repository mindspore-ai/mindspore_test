...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_CUMMAX_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_CUMMAX_H_
...
namespace mindspore {
namespace ops {
class OPS_API CummaxFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_CUMMAX_H_
