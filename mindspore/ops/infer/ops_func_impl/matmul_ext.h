...
OPS_API ShapeVector CheckMatMulShapes(const ShapeVector &shape1, const ShapeVector &shape2);
OPS_API ShapeVector InferShapeRem(const ShapeVector &shape_backbone, const ShapeVector &shape1,
                                  const ShapeVector &shape2, bool transpose_b);
OPS_API ShapeVector GetMatMulExtBroadcastShape(const ShapeVector &base_shape, const ShapeVector &input_shape);
}  // namespace ops
}  // namespace mindspore
