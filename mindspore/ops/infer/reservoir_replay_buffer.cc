...
#include "infer/reservoir_replay_buffer.h"
...
class OPS_API CreateInfer : public abstract::OpInferBase {
 public:
...
class OPS_API CommonInfer : public abstract::OpInferBase {
 public:
  BaseShapePtr InferShape(const PrimitivePtr &primitive,
                          const std::vector<AbstractBasePtr> &input_args) const override {
    return CommonInferShape(primitive, input_args);
...
class OPS_API SampleInfer : public abstract::OpInferBase {
 public:
  BaseShapePtr InferShape(const PrimitivePtr &primitive,
                          const std::vector<AbstractBasePtr> &input_args) const override {
    MS_EXCEPTION_IF_NULL(primitive);
