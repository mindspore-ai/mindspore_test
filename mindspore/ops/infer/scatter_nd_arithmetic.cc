...
#include "infer/scatter_nd_add.h"
#include "infer/scatter_nd_div.h"
#include "infer/scatter_nd_max.h"
#include "infer/scatter_nd_min.h"
#include "infer/scatter_nd_mul.h"
...
class OPS_API AGScatterNdArithmeticInfer : public abstract::OpInferBase {
 public:
