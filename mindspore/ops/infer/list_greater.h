...
#ifndef MINDSPORE_CORE_OPS_LIST_GREATER_H_
#define MINDSPORE_CORE_OPS_LIST_GREATER_H_
...
class list_greater_than : public BaseOperator {
 public:
...
class list_greater_equal : public BaseOperator {
 public:
...
#endif  // MINDSPORE_CORE_OPS_LIST_GREATER_H_
