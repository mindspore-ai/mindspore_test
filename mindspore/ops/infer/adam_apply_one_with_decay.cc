...
class OPS_API AdamApplyOneWithDecayInfer : public abstract::OpInferBase {
 public:
...
class OPS_API AdamApplyOneWithDecay : public BaseOperator {
 public:
...
class OPS_API AdamApplyOneWithDecayAssign : public BaseOperator {
 public:
