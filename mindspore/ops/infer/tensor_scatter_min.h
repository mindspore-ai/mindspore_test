...
#ifndef MINDSPORE_CORE_OPS_TENSOR_SCATTER_MIN_H_
#define MINDSPORE_CORE_OPS_TENSOR_SCATTER_MIN_H_
#include <memory>
#include <vector>
...
namespace mindspore {
namespace ops {
constexpr auto kNameTensorScatterMin = "TensorScatterMin";
...
class TensorScatterMin : public BaseOperator {
 public:
  ...
  /// \brief Constructor.
  TensorScatterMin() : BaseOperator(kNameTensorScatterMin) { InitIOName({"input_x", "indices", "updates"}, {"y"}); }
};

using kPrimTensorScatterMinPtr = std::shared_ptr<TensorScatterMin>;
}  // namespace ops
}  // namespace mindspore

#endif  // MINDSPORE_CORE_OPS_TENSOR_SCATTER_MIN_H_
