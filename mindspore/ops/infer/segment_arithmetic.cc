...
#include "infer/segment_mean.h"
#include "infer/segment_min.h"
#include "infer/segment_prod.h"
#include "infer/segment_sum.h"
...
abstract::ShapePtr SegmentArithmeticInferShape(const PrimitivePtr &primitive,
  ...
  auto segment_ids_ptr = input_args[1];
  if (IsValueKnown(segment_ids_ptr)) {
...
class OPS_API AGSegmentArithmeticInfer : public abstract::OpInferBase {
 public:
