...
#ifndef MINDSPORE_CORE_OPS_CSR_SPAESE_MATRIX_TO_SPARSE_TENSOR_H_
#define MINDSPORE_CORE_OPS_CSR_SPAESE_MATRIX_TO_SPARSE_TENSOR_H_
#include <memory>
#include <vector>
...
#endif  // MINDSPORE_CORE_OPS_CSR_SPAESE_MATRIX_TO_SPARSE_TENSOR_H_
