...
#include "infer/scatter_arithmetic.h"
#include <map>
#include <set>
#include <string>
...
#include "infer/scatter_add.h"
#include "infer/scatter_div.h"
#include "infer/scatter_max.h"
#include "infer/scatter_min.h"
...
class OPS_API AGScatterArithmeticInfer : public abstract::OpInferBase {
 public:
