...
#include "infer/tensor_scatter_arithmetic.h"
...
#include "infer/tensor_scatter_mul.h"
#include "infer/tensor_scatter_sub.h"
...
class OPS_API AGTensorScatterArithmeticInfer : public abstract::OpInferBase {
 public:
