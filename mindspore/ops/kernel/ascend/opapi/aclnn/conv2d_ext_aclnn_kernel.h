 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONV2D_EXT_ACLNN_KERNEL_MOD_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONV2D_EXT_ACLNN_KERNEL_MOD_H_
#include <vector>
#include <utility>
#include <memory>
...
class Conv2DExtAscend : public AclnnKernelMod {
 public:
  Conv2DExtAscend() : AclnnKernelMod(std::move("aclnnConvolution")) {}
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONV2D_EXT_ACLNN_KERNEL_MOD_H_
