...
class CustomV2AclnnKernelMod : public AclnnKernelMod {
 ...
 private:
  ...
  void InitInputType(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &outputs);
