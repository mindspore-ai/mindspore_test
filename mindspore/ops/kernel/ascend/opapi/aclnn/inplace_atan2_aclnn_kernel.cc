 ...
 */
#include "kernel/ascend/opapi/aclnn/inplace_atan2_aclnn_kernel.h"
#include <vector>
#include "ir/tensor.h"
...
void InplaceAtan2AclnnKernelMod::GetWorkSpaceInfo(const std::vector<KernelTensor *> &inputs,
...
bool InplaceAtan2AclnnKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
...
MS_ACLNN_KERNEL_FACTORY_REG(InplaceAtan2, InplaceAtan2AclnnKernelMod);
}  // namespace kernel
}  // namespace mindspore
