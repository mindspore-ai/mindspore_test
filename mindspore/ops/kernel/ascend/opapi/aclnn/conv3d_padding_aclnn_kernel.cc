...
TensorStorageInfoPtr Conv3DPaddingAscend::CreateTensorStorageInfoPtr(
...
template <typename T>
void Conv3DPaddingAscend::SetTensorStorageInfo(T kernel_tensor, const ShapeVector &new_shape) {
