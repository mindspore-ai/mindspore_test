...
#include "kernel/ascend/pyboost/customize/dropout_grad_ext.h"
...
namespace kernel {
namespace pyboost {
tensor::TensorPtr DropoutGradExtAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input,
                                                    const TensorPtr &mask, const FP64ImmPtr &p) {
