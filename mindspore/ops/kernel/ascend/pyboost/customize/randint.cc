...
namespace kernel {
namespace pyboost {
tensor::TensorPtr RandIntAscendCustomize(const std::shared_ptr<OpRunner> &op, const Int64ImmPtr low,
                                         const Int64ImmPtr high, const ValueTuplePtr &shape, const TensorPtr &seed,
