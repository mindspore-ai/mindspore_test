...
tensor::TensorPtr MulsAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input_tensor,
  ...
  // Async
  PyBoostUtils::DispatchRun(std::make_shared<runtime::PyBoostDeviceTask>([op, input_tensor, other_scalar]() {
    ...
    LAUNCH_ACLNN(aclnnMuls, device_context, op->stream_id(), input_tensor, other_scalar, outputs[0]);
