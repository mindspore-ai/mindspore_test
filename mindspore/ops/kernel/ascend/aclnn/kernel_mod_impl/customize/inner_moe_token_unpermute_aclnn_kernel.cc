 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/inner_moe_token_unpermute_aclnn_kernel.h"
...
void InnerMoeTokenUnpermuteAscend::GetWorkSpaceInfo(const std::vector<KernelTensor *> &inputs,
  ...
  GetWorkspaceForResize(inputs[kIndex0], inputs[kIndex1], inputs[kIndex2], padded_mode, restore_shape_val,
                        outputs[kIndex0]);
}
