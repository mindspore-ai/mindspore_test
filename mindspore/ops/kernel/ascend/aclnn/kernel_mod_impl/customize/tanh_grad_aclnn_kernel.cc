 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/tanh_grad_aclnn_kernel.h"
#include <map>
#include <memory>
#include <functional>
#include "ir/tensor.h"
...
bool TanhGradAscend::Launch(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &workspace,
