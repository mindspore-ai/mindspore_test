 ...
 */
#include "mindspore/ops/kernel/ascend/aclnn/kernel_mod_impl/customize/inplace_log_aclnn_kernel.h"
...
bool InplaceLogAscend::Launch(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &workspace,
