 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/std_mean_aclnn_kernel.h"
#include <map>
#include <memory>
#include <functional>
#include "ir/tensor.h"
...
void StdMeanAscend::GetWorkSpaceInfo(const std::vector<KernelTensor *> &inputs,
...
bool StdMeanAscend::Launch(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &workspace,
...
MS_ACLNN_KERNEL_FACTORY_REG(StdMean, StdMeanAscend);
}  // namespace std_mean
}  // namespace kernel
}  // namespace mindspore
