 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/inplace_clamp_tensor_aclnn_kernel.h"
#include <vector>
#include "ir/tensor.h"
...
bool InplaceClampTensorAclnnKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
