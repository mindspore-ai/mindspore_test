 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/nllloss_aclnn_kernel.h"
#include <vector>
...
namespace kernel {
namespace nllloss {
void NLLLossAclnnKernelMod::GetWorkSpaceInfo(const std::vector<KernelTensor *> &inputs,
...
bool NLLLossAclnnKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
...
MS_ACLNN_KERNEL_FACTORY_REG(NLLLoss, NLLLossAclnnKernelMod);
}  // namespace nllloss
}  // namespace kernel
}  // namespace mindspore
