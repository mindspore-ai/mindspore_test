 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/view/split_with_size_view.h"
...
void SplitWithSizeView::UpdateOutputTensorInfo(const std::vector<KernelTensor *> &inputs,
  ...
  info_ = ops::SplitWithSizeStridesCalc(input->GetShapeVector(), GetTensorStride(input), input->tensor_storage_info(),
                                        split_size, dim);
