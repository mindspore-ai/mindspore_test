 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/view/select_ext_view.h"
...
void SelectExtViewAscend::UpdateOutputTensorInfo(const std::vector<KernelTensor *> &inputs,
...
void SelectExtViewAscend::GetWorkSpaceInfo(const std::vector<KernelTensor *> &inputs,
                                           const std::vector<KernelTensor *> &outputs) {
  UpdateOutputTensorInfo(inputs, outputs);
}

bool SelectExtViewAscend::Launch(const std::vector<KernelTensor *> &inputs,
                                 const std::vector<KernelTensor *> &workspace,
                                 const std::vector<KernelTensor *> &outputs, void *stream_ptr) {
  return true;
}

MS_ACLNN_KERNEL_FACTORY_REG(SelectExtView, SelectExtViewAscend);
}  // namespace kernel
}  // namespace mindspore
