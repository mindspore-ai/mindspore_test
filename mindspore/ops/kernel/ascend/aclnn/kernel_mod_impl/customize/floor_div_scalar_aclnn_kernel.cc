 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/floor_div_scalar_aclnn_kernel.h"
#include "ir/tensor.h"
...
bool FloorDivScalarAscend::Launch(const std::vector<KernelTensor *> &inputs,
