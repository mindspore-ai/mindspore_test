 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/new_zeros_aclnn_kernel.h"
...
bool NewZerosAscend::Launch(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &workspace,
