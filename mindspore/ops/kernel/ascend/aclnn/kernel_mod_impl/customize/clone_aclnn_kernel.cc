 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/clone_aclnn_kernel.h"
...
bool CloneAscend::Launch(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &workspace,
