 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/binary_cross_entropy_with_logits.h"
#include <vector>
...
bool BinaryCrossEntropyWithLogitsAclnnKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
...
MS_ACLNN_KERNEL_FACTORY_REG(BCEWithLogitsLoss, BinaryCrossEntropyWithLogitsAclnnKernelMod);
}  // namespace kernel
}  // namespace mindspore
