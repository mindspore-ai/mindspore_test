 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/divmods_aclnn_kernel.h"
#include "ir/tensor.h"
...
bool DivModsAscend::Launch(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &workspace,
                           const std::vector<KernelTensor *> &outputs, void *stream_ptr) {
  MS_EXCEPTION_IF_NULL(stream_ptr);
  RunOp(stream_ptr, workspace, inputs[kIndex0], other_, mode_, outputs[kIndex0]);
  return true;
}
