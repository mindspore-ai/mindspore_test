 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/inplace_floor_aclnn_kernel.h"
#include <vector>
#include "ir/tensor.h"
...
bool InplaceFloorAclnnKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
