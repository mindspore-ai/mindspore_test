 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/inplace_relu_aclnn_kernel.h"
#include <vector>
#include "ir/tensor.h"
...
bool InplaceReLUAclnnKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
