 ...
 */
#include "kernel/ascend/aclnn/kernel_mod_impl/customize/inplace_tanh_aclnn_kernel.h"
#include <vector>
#include "ir/tensor.h"
...
bool InplaceTanhAscend::Launch(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &workspace,
