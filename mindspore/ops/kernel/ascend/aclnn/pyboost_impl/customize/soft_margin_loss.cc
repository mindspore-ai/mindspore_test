...
#include "kernel/ascend/aclnn/pyboost_impl/customize/soft_margin_loss.h"
#include <memory>
...
namespace kernel {
namespace pyboost {
tensor::TensorPtr SoftMarginLossAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input_tensor,
