...
#include "kernel/ascend/aclnn/pyboost_impl/customize/max_pool_grad_with_mask.h"
...
tensor::TensorPtr MaxPoolGradWithMaskAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &x_tensor,
