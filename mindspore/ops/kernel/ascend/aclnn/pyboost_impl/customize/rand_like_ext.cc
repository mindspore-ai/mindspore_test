...
#include "kernel/ascend/aclnn/pyboost_impl/customize/rand_like_ext.h"
...
namespace kernel {
namespace pyboost {
tensor::TensorPtr RandLikeExtAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &tensor_tensor,
