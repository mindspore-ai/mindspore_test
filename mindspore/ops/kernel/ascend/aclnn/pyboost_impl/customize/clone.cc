 ...
 */
#include "kernel/ascend/aclnn/pyboost_impl/customize/clone.h"
...
namespace kernel {
namespace pyboost {
tensor::TensorPtr CloneAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input_tensor) {
  MS_LOG(DEBUG) << "Clone Call start";
