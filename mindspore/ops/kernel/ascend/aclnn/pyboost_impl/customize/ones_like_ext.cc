...
#include "kernel/ascend/aclnn/pyboost_impl/customize/ones_like_ext.h"
#include <memory>
...
namespace kernel {
namespace pyboost {
tensor::TensorPtr OnesLikeExtAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input_tensor,
