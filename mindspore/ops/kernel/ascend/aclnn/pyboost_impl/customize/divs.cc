...
#include "kernel/ascend/aclnn/pyboost_impl/customize/divs.h"
#include <memory>
...
namespace kernel {
namespace pyboost {
tensor::TensorPtr DivsAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input_tensor,
