...
#include "kernel/ascend/aclnn/pyboost_impl/customize/zeros_like_ext.h"
#include <memory>
...
namespace kernel {
namespace pyboost {
tensor::TensorPtr ZerosLikeExtAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input_tensor,
