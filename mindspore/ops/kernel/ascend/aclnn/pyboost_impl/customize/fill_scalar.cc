...
#include "kernel/ascend/aclnn/pyboost_impl/customize/fill_scalar.h"
#include <memory>
...
namespace kernel {
namespace pyboost {
tensor::TensorPtr FillScalarAscendCustomize(const std::shared_ptr<OpRunner> &op, const ValueTuplePtr &size,
