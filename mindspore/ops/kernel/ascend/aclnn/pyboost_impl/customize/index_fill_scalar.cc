...
#include "kernel/ascend/aclnn/pyboost_impl/customize/index_fill_scalar.h"
#include <memory>
#include <string>
...
tensor::TensorPtr IndexFillScalarAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input,
