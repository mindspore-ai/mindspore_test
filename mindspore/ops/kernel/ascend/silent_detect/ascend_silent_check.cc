...
#include "mindspore/ccsrc/pynative/utils/pyboost/auto_generate/norm.h"
#include "mindspore/ccsrc/pynative/utils/pyboost/auto_generate/silent_check_v2.h"
#include "mindspore/ccsrc/pynative/utils/pyboost/auto_generate/silent_check_v3.h"
#include "mindspore/ccsrc/pynative/utils/pyboost/auto_generate/square.h"
...
KernelTensorPtr SilentChecker::GenerateKernelTensor(TypeId dtype_id, const ShapeVector &shape, const ValuePtr &value,
  ...
  auto tensor =
    AnfAlgo::CreateKernelTensor(addr, mem_size, Format::DEFAULT_FORMAT, dtype_id, shape,
                                device::GetDeviceNameByType(device_context_->device_context_key().device_type_),
