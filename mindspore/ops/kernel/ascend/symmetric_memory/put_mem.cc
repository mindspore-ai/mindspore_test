...
#include "kernel/ascend/symmetric_memory/put_mem.h"
...
namespace mindspore {
namespace kernel {
symmetricmemory::SymmetricMemoryOpPtr SymmetricMemoryPutMem::CreateKernel(
...
MS_SYMMETRIC_MEMORY_KERNEL_FACTORY_REG(PutMem, symmetricmemory::kSymmetricMemoryPutMemOpName, SymmetricMemoryPutMem);
REG_MS_TO_SYMMETRIC_MEMORY_IN_TENSOR_IDX_MAP(PutMem, INPUT_NUM_5, INDEX_0, INDEX_1, INDEX_2, INDEX_3, INDEX_4);
}  // namespace kernel
}  // namespace mindspore
