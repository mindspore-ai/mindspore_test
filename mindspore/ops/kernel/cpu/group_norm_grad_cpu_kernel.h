...
#ifndef MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_GROUP_NORM_GRAD_CPU_KERNEL_H_
#define MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_GROUP_NORM_GRAD_CPU_KERNEL_H_
...
class GroupNormGradCpuKernelMod : public NativeCpuKernelMod {
 public:
  ...
  ~GroupNormGradCpuKernelMod() override = default;
 ...
 private:
  ...
  using KernelFunc = std::function<void(GroupNormGradCpuKernelMod *, const std::vector<KernelTensor *> &,
