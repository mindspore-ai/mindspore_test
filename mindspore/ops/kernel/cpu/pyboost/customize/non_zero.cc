...
#include "mindspore/ops/kernel/cpu/pyboost/customize/non_zero.h"
...
namespace kernel {
namespace pyboost {
tensor::TensorPtr NonZeroCPUCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input_tensor) {
