...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_FILL_DIAGONAL_CPU_KERNEL_H_
...
class FillDiagonalCpuKernelMod : public NativeCpuKernelMod {
 public:
  ...
  ~FillDiagonalCpuKernelMod() override = default;
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_FILL_DIAGONAL_CPU_KERNEL_H_
