...
#include "kernel/cpu/eigen/bessel_k0_cpu_kernel.h"

#include "mindspore/ops/infer/bessel_k0.h"
...
bool BesselK0CpuKernelMod::Init(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &outputs) {
...
int BesselK0CpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
...
template <typename T>
bool BesselK0CpuKernelMod::LaunchKernel(const std::vector<kernel::KernelTensor *> &inputs,
