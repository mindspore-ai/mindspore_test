...
#include "kernel/cpu/eigen/bessel_j1_cpu_kernel.h"

#include "mindspore/ops/infer/bessel_j1.h"
...
bool BesselJ1CpuKernelMod::Init(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &outputs) {
...
int BesselJ1CpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
...
template <typename T>
bool BesselJ1CpuKernelMod::LaunchKernel(const std::vector<kernel::KernelTensor *> &inputs,
