...
#include <iostream>
#include "kernel/cpu/native/csr_sparse_matrix_to_sparse_tensor_cpu_kernel.h"
...
bool CSRSparseMatrixToSparseTensorCpuKernelMod::Launch(const std::vector<kernel::KernelTensor *> &inputs,
