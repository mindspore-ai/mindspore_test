...
#include "kernel/cpu/native/sequence/sequence_mul_cpu_kernel.h"
#include <algorithm>
#include <utility>
#include <complex>
...
bool SequenceMulCpuKernelMod::Init(const std::vector<KernelTensor *> &inputs,
...
int SequenceMulCpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
                                    const std::vector<KernelTensor *> &outputs) {
