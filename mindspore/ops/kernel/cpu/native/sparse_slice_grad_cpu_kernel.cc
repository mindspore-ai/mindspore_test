...
#include "kernel/cpu/native/sparse_slice_grad_cpu_kernel.h"
#include <algorithm>
#include <complex>
...
#define SPARSE_SLICE_GRAD_ADD_KERNEL(dtype, type)      \
  {                                                    \
    KernelAttr()                                       \
...
const std::vector<std::pair<KernelAttr, SparseSliceGradCpuKernelMod::KernelRunFunc>>
  ...
  static const std::vector<std::pair<KernelAttr, SparseSliceGradCpuKernelMod::KernelRunFunc>> func_list = {
    SPARSE_SLICE_GRAD_ADD_KERNEL(Bool, bool),           SPARSE_SLICE_GRAD_ADD_KERNEL(UInt8, uint8_t),
    SPARSE_SLICE_GRAD_ADD_KERNEL(UInt16, uint16_t),     SPARSE_SLICE_GRAD_ADD_KERNEL(Int8, int8_t),
    SPARSE_SLICE_GRAD_ADD_KERNEL(Int16, int16_t),       SPARSE_SLICE_GRAD_ADD_KERNEL(Int32, int),
    SPARSE_SLICE_GRAD_ADD_KERNEL(UInt32, uint32_t),     SPARSE_SLICE_GRAD_ADD_KERNEL(UInt64, uint64_t),
    SPARSE_SLICE_GRAD_ADD_KERNEL(Int64, int64_t),       SPARSE_SLICE_GRAD_ADD_KERNEL(Float16, float16),
    SPARSE_SLICE_GRAD_ADD_KERNEL(Float32, float),       SPARSE_SLICE_GRAD_ADD_KERNEL(Float64, double),
    SPARSE_SLICE_GRAD_ADD_KERNEL(Complex64, complex64), SPARSE_SLICE_GRAD_ADD_KERNEL(Complex128, complex128),
  };
  return func_list;
}
