...
#include "mindspore/ops/infer/batch_to_space_nd.h"
#include "kernel/cpu/native/batch_to_space_nd_cpu_kernel.h"
...
template <typename T>
bool BatchToSpaceNDCpuKernelMod::LaunchKernel(const std::vector<kernel::KernelTensor *> &inputs,
