...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_KL_DIV_LOSS_GRAD_CPU_KERNEL_H
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_KL_DIV_LOSS_GRAD_CPU_KERNEL_H
...
class KLDivLossGradCpuKernelMod : public NativeCpuKernelMod {
 public:
  ...
  ~KLDivLossGradCpuKernelMod() override = default;
