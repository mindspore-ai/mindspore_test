...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_APPLY_PROXIMAL_ADAGRAD_CPU_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_APPLY_PROXIMAL_ADAGRAD_CPU_KERNEL_H_
...
class ApplyProximalAdagradCpuKernelMod : public NativeCpuKernelMod {
 public:
  ...
  ~ApplyProximalAdagradCpuKernelMod() override = default;
