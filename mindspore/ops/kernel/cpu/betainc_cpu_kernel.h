...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_BETAINC_CPU_KERNEL_H_
...
class BetaincCpuKernelMod : public NativeCpuKernelMod, public MatchKernelHelper<BetaincCpuKernelMod> {
 public:
  ...
  ~BetaincCpuKernelMod() override = default;
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_BETAINC_CPU_KERNEL_H_
