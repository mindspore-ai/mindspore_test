...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_SCALE_GRAD_CPU_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_SCALE_GRAD_CPU_KERNEL_H_
...
class ScaleGradCpuKernelMod : public NativeCpuKernelMod {
 public:
  ...
  ~ScaleGradCpuKernelMod() override = default;
