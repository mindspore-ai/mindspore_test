...
#include "kernel/cpu/sequence/sequence_to_tensor_cpu_kernel.h"
#include <algorithm>
#include <utility>
#include <complex>
...
std::vector<std::pair<KernelAttr, SeqToTensorCpuKernelMod::SeqToTensorFunc>>
  SeqToTensorCpuKernelMod::scalar_func_list_ = {
    ...
    ADD_SCALAR_KERNEL(Float32, Bool, float, bool),      ADD_SCALAR_KERNEL(Float32, Float16, float, float16),
    ...
    ADD_SCALAR_KERNEL(Float64, Bool, double, bool),     ADD_SCALAR_KERNEL(Float64, Float16, double, float16),
    ...
    ADD_SCALAR_KERNEL(Int32, Bool, int32_t, bool),      ADD_SCALAR_KERNEL(Int32, Float16, int32_t, float16),
    ...
    ADD_SCALAR_KERNEL(Int64, Bool, int64_t, bool),      ADD_SCALAR_KERNEL(Int64, Float16, int64_t, float16),
    ...
    ADD_SCALAR_KERNEL(Bool, Bool, bool, bool),          ADD_SCALAR_KERNEL(Bool, Float16, bool, float16)};
