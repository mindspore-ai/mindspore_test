...
#include "kernel/gpu/cuda/nn/dilation2d_backprop_filter_gpu_kernel.h"
#include <utility>
...
bool Dilation2DBackpropFilterGpuKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
