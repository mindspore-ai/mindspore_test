...
#include "kernel/gpu/cuda/nn/maxpool3d_grad_with_argmax_gpu_kernel.h"
#include <functional>
#include <memory>
#include "kernel/gpu/cuda_impl/cuda_ops/maxpool3d_grad_with_argmax_impl.cuh"
...
bool MaxPool3DGradWithArgmaxGpuKernelMod::Init(const std::vector<KernelTensor *> &inputs,
                                               const std::vector<KernelTensor *> &outputs) {
...
int MaxPool3DGradWithArgmaxGpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
                                                const std::vector<KernelTensor *> &outputs) {
