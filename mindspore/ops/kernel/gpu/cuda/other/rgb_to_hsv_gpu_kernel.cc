...
#include "kernel/gpu/cuda/other/rgb_to_hsv_gpu_kernel.h"
#include <utility>
namespace mindspore {
namespace kernel {
namespace {
...
bool RgbtohsvGpuKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
...
bool RgbtohsvGpuKernelMod::Init(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &outputs) {
...
int RgbtohsvGpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
