...
#include "kernel/gpu/cuda/arrays/scatter_arithmetic_gpu_kernel.h"
#include <utility>
#include <memory>
#include <algorithm>
...
bool ScatterArithmeticGpuKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
...
bool ScatterArithmeticGpuKernelMod::Init(const std::vector<KernelTensor *> &inputs,
...
int ScatterArithmeticGpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
                                          const std::vector<KernelTensor *> &outputs) {
...
std::vector<KernelAttr> ScatterArithmeticGpuKernelMod::GetOpSupport() {
...
MS_KERNEL_FACTORY_REG(NativeGpuKernelMod, ScatterDiv, ScatterArithmeticGpuKernelMod);
MS_KERNEL_FACTORY_REG(NativeGpuKernelMod, ScatterMul, ScatterArithmeticGpuKernelMod);
}  // namespace kernel
}  // namespace mindspore
