...
#include "kernel/gpu/cuda/arrays/parallel_concat_gpu_kernel.h"
#include <utility>
namespace mindspore {
namespace kernel {
template <typename T>
...
bool ParallelConcatGpuKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
...
bool ParallelConcatGpuKernelMod::Init(const std::vector<KernelTensor *> &inputs,
...
int ParallelConcatGpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
                                       const std::vector<KernelTensor *> &outputs) {
