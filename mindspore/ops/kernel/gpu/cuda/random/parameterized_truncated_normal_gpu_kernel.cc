...
#include "kernel/gpu/cuda/random/parameterized_truncated_normal_gpu_kernel.h"
#include "mindspore/ops/infer/parameterized_truncated_normal.h"
#include "kernel/gpu/cuda_impl/cuda_ops/parameterized_truncated_normal_impl.cuh"
#include <utility>
#include <memory>
#include <random>
#include <algorithm>
