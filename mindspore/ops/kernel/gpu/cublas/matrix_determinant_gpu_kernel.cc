...
int MatrixDeterminantGpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
  ...
  // For input shape and output shape's rationality have been checked in ops/infer/matrix_determinant or
  // ops/infer/log_matrix_determinant , we ignore shape's checking.
