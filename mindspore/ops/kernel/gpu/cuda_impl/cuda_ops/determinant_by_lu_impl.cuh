...
template <typename T>
CUDA_LIB_EXPORT cudaError_t CalculateDeterminantByLu(const T *lu_input, const int *pivot, int m, int batch_size,
                                                     bool is_sign_log_determinant, T *determinant_output,
                                                     T *sign_output, const uint32_t &device_id,
