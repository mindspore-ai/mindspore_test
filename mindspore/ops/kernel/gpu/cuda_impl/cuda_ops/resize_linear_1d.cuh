...
template <typename T>
CUDA_LIB_EXPORT cudaError_t ResizeLinear1D(const enum ResizeLinearCoordinateTransformationMode mode,
...
template <typename T>
CUDA_LIB_EXPORT cudaError_t ResizeLinear1DGrad(const enum ResizeLinearCoordinateTransformationMode mode,
                                               const int64_t batch, const int64_t channel, const int64_t in_width,
                                               const int64_t out_width, const T *grad_output, T *grad_input,
