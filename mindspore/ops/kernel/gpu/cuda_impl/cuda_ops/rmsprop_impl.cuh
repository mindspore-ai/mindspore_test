...
template <typename T>
CUDA_LIB_EXPORT cudaError_t RmsProp(const size_t batch_size, const size_t input_elements, const T *learning_rate,
...
template <typename T>
CUDA_LIB_EXPORT cudaError_t RmsPropCenter(const size_t batch_size, const size_t input_elements, const T *learning_rate,
                                          const T *decay, const T *momentum, const T *epsilon, T *variable,
