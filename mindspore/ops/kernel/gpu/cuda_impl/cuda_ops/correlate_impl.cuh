...
template <typename T>
CUDA_LIB_EXPORT cudaError_t CorrelateCalc(const T *input_addr, const T *kernel_addr, T *output_addr,
                                          const size_t input_size, const size_t kernel_size, const int64_t mode,
                                          const uint32_t &device_id, cudaStream_t stream);

template <typename T>
CUDA_LIB_EXPORT cudaError_t CalConj(const T *input_addr, T *output_addr, const size_t input_size,
                                    const uint32_t &device_id, cudaStream_t stream);

template <typename T>
CUDA_LIB_EXPORT cudaError_t CalReverse1D(const T *input_addr, T *output_addr, const size_t *input_size_d,
