...
cudaError_t CumMax(const DataType *input_ptr, DataType *value_ptr, IndexType *index_ptr, size_t outer_size_st,
                   size_t axis_size_st, size_t inner_size_st, const uint32_t &device_id, cudaStream_t cuda_stream) {
  KernelHelper(BinaryFunctor<thrust::greater_equal<DataType>, DataType>{}, NumericMin<DataType>(), input_ptr, value_ptr,
               index_ptr, outer_size_st, axis_size_st, inner_size_st, device_id, cuda_stream);
  return GetCudaStatus();
}

template CUDA_LIB_EXPORT cudaError_t CumMax<int8_t, int32_t>(const int8_t *input_ptr, int8_t *value_ptr,
                                                             int32_t *index_ptr, size_t outer_size, size_t axis_size,
                                                             size_t inner_size, const uint32_t &device_id,
                                                             cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<int16_t, int32_t>(const int16_t *input_ptr, int16_t *value_ptr,
                                                              int32_t *index_ptr, size_t outer_size, size_t axis_size,
                                                              size_t inner_size, const uint32_t &device_id,
                                                              cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<int32_t, int32_t>(const int32_t *input_ptr, int32_t *value_ptr,
                                                              int32_t *index_ptr, size_t outer_size, size_t axis_size,
                                                              size_t inner_size, const uint32_t &device_id,
                                                              cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<int64_t, int32_t>(const int64_t *input_ptr, int64_t *value_ptr,
                                                              int32_t *index_ptr, size_t outer_size, size_t axis_size,
                                                              size_t inner_size, const uint32_t &device_id,
                                                              cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<uint8_t, int32_t>(const uint8_t *input_ptr, uint8_t *value_ptr,
                                                              int32_t *index_ptr, size_t outer_size, size_t axis_size,
                                                              size_t inner_size, const uint32_t &device_id,
                                                              cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<uint16_t, int32_t>(const uint16_t *input_ptr, uint16_t *value_ptr,
                                                               int32_t *index_ptr, size_t outer_size, size_t axis_size,
                                                               size_t inner_size, const uint32_t &device_id,
                                                               cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<uint32_t, int32_t>(const uint32_t *input_ptr, uint32_t *value_ptr,
                                                               int32_t *index_ptr, size_t outer_size, size_t axis_size,
                                                               size_t inner_size, const uint32_t &device_id,
                                                               cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<uint64_t, int32_t>(const uint64_t *input_ptr, uint64_t *value_ptr,
                                                               int32_t *index_ptr, size_t outer_size, size_t axis_size,
                                                               size_t inner_size, const uint32_t &device_id,
                                                               cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<half, int32_t>(const half *input_ptr, half *value_ptr, int32_t *index_ptr,
                                                           size_t outer_size, size_t axis_size, size_t inner_size,
                                                           const uint32_t &device_id, cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<float, int32_t>(const float *input_ptr, float *value_ptr,
                                                            int32_t *index_ptr, size_t outer_size, size_t axis_size,
                                                            size_t inner_size, const uint32_t &device_id,
                                                            cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<double, int32_t>(const double *input_ptr, double *value_ptr,
                                                             int32_t *index_ptr, size_t outer_size, size_t axis_size,
                                                             size_t inner_size, const uint32_t &device_id,
                                                             cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<int8_t, int64_t>(const int8_t *input_ptr, int8_t *value_ptr,
                                                             int64_t *index_ptr, size_t outer_size, size_t axis_size,
                                                             size_t inner_size, const uint32_t &device_id,
                                                             cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<int16_t, int64_t>(const int16_t *input_ptr, int16_t *value_ptr,
                                                              int64_t *index_ptr, size_t outer_size, size_t axis_size,
                                                              size_t inner_size, const uint32_t &device_id,
                                                              cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<int32_t, int64_t>(const int32_t *input_ptr, int32_t *value_ptr,
                                                              int64_t *index_ptr, size_t outer_size, size_t axis_size,
                                                              size_t inner_size, const uint32_t &device_id,
                                                              cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<int64_t, int64_t>(const int64_t *input_ptr, int64_t *value_ptr,
                                                              int64_t *index_ptr, size_t outer_size, size_t axis_size,
                                                              size_t inner_size, const uint32_t &device_id,
                                                              cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<uint8_t, int64_t>(const uint8_t *input_ptr, uint8_t *value_ptr,
                                                              int64_t *index_ptr, size_t outer_size, size_t axis_size,
                                                              size_t inner_size, const uint32_t &device_id,
                                                              cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<uint16_t, int64_t>(const uint16_t *input_ptr, uint16_t *value_ptr,
                                                               int64_t *index_ptr, size_t outer_size, size_t axis_size,
                                                               size_t inner_size, const uint32_t &device_id,
                                                               cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<uint32_t, int64_t>(const uint32_t *input_ptr, uint32_t *value_ptr,
                                                               int64_t *index_ptr, size_t outer_size, size_t axis_size,
                                                               size_t inner_size, const uint32_t &device_id,
                                                               cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<uint64_t, int64_t>(const uint64_t *input_ptr, uint64_t *value_ptr,
                                                               int64_t *index_ptr, size_t outer_size, size_t axis_size,
                                                               size_t inner_size, const uint32_t &device_id,
                                                               cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<half, int64_t>(const half *input_ptr, half *value_ptr, int64_t *index_ptr,
                                                           size_t outer_size, size_t axis_size, size_t inner_size,
                                                           const uint32_t &device_id, cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<float, int64_t>(const float *input_ptr, float *value_ptr,
                                                            int64_t *index_ptr, size_t outer_size, size_t axis_size,
                                                            size_t inner_size, const uint32_t &device_id,
                                                            cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT cudaError_t CumMax<double, int64_t>(const double *input_ptr, double *value_ptr,
                                                             int64_t *index_ptr, size_t outer_size, size_t axis_size,
                                                             size_t inner_size, const uint32_t &device_id,
                                                             cudaStream_t cuda_stream);
