...
#include <limits>
#include "kernel/gpu/cuda_impl/cuda_ops/dilation2d_impl.cuh"
...
template <typename T>
cudaError_t CalDilation2D(const T *input, const T *filter, T *output, const std::vector<int64_t> &input_shape,
