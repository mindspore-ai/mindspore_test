...
CUDA_LIB_EXPORT cudaError_t CalSparseApplyAdagradV2(const size_t size, const size_t indices_size,
                                                    const float learning_rate, const float epsilon,
                                                    const bool update_slots, const T *gradient, const S *indices,
