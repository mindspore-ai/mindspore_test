...
template <typename T>
CUDA_LIB_EXPORT cudaError_t CalHypot(size_t size, const T *x1, const T *x2, T *y, const uint32_t &device_id,
                                     cudaStream_t cuda_stream);

template <typename T>
CUDA_LIB_EXPORT cudaError_t BroadcastHypot(const std::vector<size_t> &x1_shape, const std::vector<size_t> &x2_shape,
