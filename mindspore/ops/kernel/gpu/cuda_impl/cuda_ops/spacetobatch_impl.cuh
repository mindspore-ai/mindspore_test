...
template <typename T>
CUDA_LIB_EXPORT cudaError_t CalSpaceToBatch(const size_t size, const T *input, const size_t in, const size_t ih,
                                            const size_t iw, const size_t ic, const size_t on, const size_t oh,
                                            const size_t ow, const size_t oc, const size_t pad_up, const size_t pad_dn,
