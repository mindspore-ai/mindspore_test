...
template <typename T, typename S>
cudaError_t UnsortedSegmentSum(size_t input_dim0, size_t input_dim1, size_t output_dim0, size_t output_dim1,
...
template CUDA_LIB_EXPORT cudaError_t UnsortedSegmentSum(size_t input_dim0, size_t input_dim1, size_t output_dim0,
