...
template <typename T>
CUDA_LIB_EXPORT cudaError_t CalLayerNormGradGrad(const int &row_dim, const int &col_dim, const int &param_dim,
                                                 T *global_sum1, T *global_sum2, const T &epsilon, const T *dy,
