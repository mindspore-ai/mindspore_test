...
#include "kernel/gpu/arrays/lower_bound_gpu_kernel.h"
...
MS_KERNEL_FACTORY_REG(NativeGpuKernelMod, LowerBound, LowerBoundGpuKernelMod);
}  // namespace kernel
}  // namespace mindspore
