 ...
 */
#include "kernel/gpu/quant/fake_learned_scale_quant_perchannel_grad_gpu_kernel.h"
#include "kernel/gpu/cuda_impl/cuda_ops/fake_learned_scale_quant_perchannel_impl.cuh"
