...
#include "kernel/gpu/pyboost/customize/new_zeros.h"
#include "kernel/gpu/pyboost/auto_generate/zeros.h"

namespace mindspore {
namespace kernel {
namespace pyboost {
void NewZerosGPUCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input_tensor, const ValueTuplePtr &size,
