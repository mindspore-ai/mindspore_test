 ...
 */
#include "kernel/gpu/pyboost/customize/divmods.h"
#include <memory>
#include <utility>
...
namespace kernel {
namespace pyboost {
void DivModsGPUCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &x_tensor, const ScalarPtr &y_scalar,
  ...
  // handle type promotion manually since the GPU kernelmod DivMods does not support it
