...
#include "kernel/gpu/pyboost/customize/inner_comm_reduce_scatter.h"
...
namespace kernel {
namespace pyboost {
void InnerCommReduceScatterGPUCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input_tensor,
