...
#include "kernel/gpu/nn/hswish_grad_gpu_kernel.h"
#include "kernel/gpu/cuda_impl/cuda_ops/hswish_impl.cuh"
...
template <typename T>
bool HSwishGradGpuKernelMod::LaunchKernel(const std::vector<KernelTensor *> &inputs,
