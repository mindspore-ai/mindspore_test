...
def test_chunk_pyboost(mode):
    ...
    assert np.allclose(output6[0].asnumpy(), expect_outs_1)
    assert np.allclose(output6[1].asnumpy(), expect_outs_2)
    assert np.allclose(output6[2].asnumpy(), expect_outs_3)
...
def test_chunk_python(mode):
    ...
    expect_outs_2 = np.array([3, 4, 5]).astype(np.float32)
    expect_outs_3 = np.array([6, 7, 8]).astype(np.float32)
    assert np.allclose(output1[0].asnumpy(), expect_outs_1)
    assert np.allclose(output1[1].asnumpy(), expect_outs_2)
    assert np.allclose(output1[2].asnumpy(), expect_outs_3)
    assert np.allclose(output2[0].asnumpy(), expect_outs_1)
    assert np.allclose(output2[1].asnumpy(), expect_outs_2)
    assert np.allclose(output2[2].asnumpy(), expect_outs_3)
    assert np.allclose(output3[0].asnumpy(), expect_outs_1)
    assert np.allclose(output3[1].asnumpy(), expect_outs_2)
    assert np.allclose(output3[2].asnumpy(), expect_outs_3)
