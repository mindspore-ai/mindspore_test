...
def test_not_use_dryrunmock_not_in_simulation():
    ...
    Expectation: no err.
    """
    cmd = "python dryrun_case.py --test_case 0 >dryrun0.log 2>&1"
    ret = os.system(cmd)
    assert ret == 0
    warning_logs = ["dryrun"]
...
def test_not_use_dryrunmock_in_simulation():
    ...
    """
    cmd = "python dryrun_case.py --test_case 1 >dryrun1.log 2>&1"
    ret = os.system(cmd)
    assert ret == 0
...
def test_use_dryrunmock_not_in_simulation():
    ...
    """
    cmd = "python dryrun_case.py --test_case 2 >dryrun2.log 2>&1"
    ret = os.system(cmd)
    assert ret == 0
    warning_logs = ["dryrun"]
...
def test_use_dryrunmock_in_simulation():
    ...
    """
    cmd = "python dryrun_case.py --test_case 3 >dryrun3.log 2>&1"
    ret = os.system(cmd)
    assert ret == 0
    warning_logs = ["dryrun"]
