...
def my_hook(x, expert_id, counter):
    ...
    sl = ops.gen_ops_prim.MoveTo()(sl, "CPU", False)
    rl = ops.gen_ops_prim.MoveTo()(rl, "CPU", False)

    sl_x = ops.gen_ops_prim.MoveTo()(sl_x, "CPU", False)
    rl_x = ops.gen_ops_prim.MoveTo()(rl_x, "CPU", False)
