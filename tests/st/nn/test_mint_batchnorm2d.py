...
def test_batchnorm2d(mode):
    ...
    if mode == 'pynative':
        ...
        output = (jit(forward_batch_norm_2d_net, jit_level="O0"))(x, num_features)
        out_grad = (jit(grad_batch_norm_2d_net, jit_level="O0"))(
            x, num_features)
    else:
        output = (jit(forward_batch_norm_2d_net, jit_level="O2"))(x, num_features)
        out_grad = (jit(grad_batch_norm_2d_net, jit_level="O2"))(
            x, num_features)
