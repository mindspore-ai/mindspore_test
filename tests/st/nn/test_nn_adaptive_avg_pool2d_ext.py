...
def forward_adaptive_avg_pool2d_net(input_x, output_size):
    net = nn.AdaptiveAvgPool2d(output_size)
    return net(input_x)


@test_utils.run_with_cell
def forward_adaptive_avg_pool2d_for_dyn(input_x):
    net = nn.AdaptiveAvgPool2d((8, 8))
    return net(input_x)
...
@ops_binary_cases(OpsBinaryCase(input_info=[((16, 4, 16, 16), np.float16)],
                                ...
                                extra_info='AdaptiveAvgPool2d'))
def nn_adaptive_avg_pool2d_case1(input_binary_data=None, output_binary_data=None):
...
def test_batchnorm2d(mode):
    ...
    nn_adaptive_avg_pool2d_case1()


@arg_mark(plat_marks=['platform_ascend'], level_mark='level1',
          card_mark='onecard', essential_mark='unessential')
def test_adaptive_avg_pool2d_dyn():
    """
    ...
    TEST_OP(forward_adaptive_avg_pool2d_for_dyn, [[in1], [in2]], '', disable_yaml_check=True,
