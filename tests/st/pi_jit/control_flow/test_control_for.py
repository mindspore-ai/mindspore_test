...
def test_control_for_range_addn():
    ...
    jit(function=ControlOneForAddn.construct, capture_mode="ast")(ps_net, Tensor(input_np))
    ...
    jit(function=ControlOneForAddn.construct, capture_mode="bytecode")(pi_net, Tensor(input_np))
...
def test_control_for_split():
    ...
    jit(function=ControlOneForSplit.construct, capture_mode="ast")(ps_net, Tensor(input_np))
    out_ps = ps_net(Tensor(input_np))
    grad_net = GradOfFirstInput(ps_net, sens_param=False)
    ps_grad = grad_net(Tensor(input_np))
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = ControlOneForSplit()
    jit(function=ControlOneForSplit.construct, capture_mode="bytecode")(pi_net, Tensor(input_np))
    out_pi = pi_net(Tensor(input_np))
    grad_net = GradOfFirstInput(pi_net, sens_param=False)
    pi_grad = grad_net(Tensor(input_np))
    match_array(out_ps, out_pi, error=4)
...
def test_control_for_if():
    ...
    jit(function=ControlOneForOneIf.construct, capture_mode="ast")(ps_net, Tensor(input_np), Tensor(x), Tensor(y), Tensor(z))
    ...
    jit(function=ControlOneForOneIf.construct, capture_mode="bytecode")(pi_net, Tensor(input_np), Tensor(x), Tensor(y), Tensor(z))
...
def test_control_for_in_for():
    ...
    jit(function=ControlOneForOneFor.construct, capture_mode="ast")(ps_net, Tensor(input_np))
    out_ps = ps_net(Tensor(input_np))
    grad_net = GradOfFirstInput(ps_net, sens_param=False)
    ps_grad = grad_net(Tensor(input_np))
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = ControlOneForOneFor()
    jit(function=ControlOneForOneFor.construct, capture_mode="bytecode")(pi_net, Tensor(input_np))
    out_pi = pi_net(Tensor(input_np))
    grad_net = GradOfFirstInput(pi_net, sens_param=False)
    pi_grad = grad_net(Tensor(input_np))
    match_array(out_ps, out_pi, error=4)
...
def test_control_while_in_for():
    ...
    jit(function=ControlOneWhileInFor.construct, capture_mode="ast")(ps_net, Tensor(input_np), Tensor(x), Tensor(y))
    ...
    jit(function=ControlOneWhileInFor.construct, capture_mode="bytecode")(pi_net, Tensor(input_np), Tensor(x), Tensor(y))
