...
def test_ctrl_while_addn_true():
    ...
    jit(function=ControlOneWhileOneAddn.construct, capture_mode="ast")(ps_net, Tensor(x), Tensor(y), Tensor(input_param))
    ...
    jit(function=ControlOneWhileOneAddn.construct, capture_mode="bytecode")(pi_net, Tensor(x), Tensor(y), Tensor(input_param))
...
def test_ctrl_while_addn_addn_true():
    ...
    jit(function=ControlOneWhileOneAddnOneAddn.construct, capture_mode="ast")(ps_net, Tensor(x), Tensor(y), Tensor(input_param))
    out_ps = ps_net(Tensor(x), Tensor(y), Tensor(input_param))
    grad_net = GradOfAllInputs(ps_net, sens_param=False)
    ps_grad = grad_net(Tensor(x), Tensor(y), Tensor(input_param))
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = ControlOneWhileOneAddnOneAddn()
    jit(function=ControlOneWhileOneAddnOneAddn.construct, capture_mode="bytecode")(pi_net, Tensor(x), Tensor(y), Tensor(input_param))
    out_pi = pi_net(Tensor(x), Tensor(y), Tensor(input_param))
    grad_net = GradOfAllInputs(pi_net, sens_param=False)
    pi_grad = grad_net(Tensor(x), Tensor(y), Tensor(input_param))
    match_array(out_pi.asnumpy(), out_ps.asnumpy())
...
def test_ctrl_while_para_true():
    ...
    jit(function=ControlOneWhileOnePara.construct, capture_mode="ast")(ps_net, Tensor(x), Tensor(y), Tensor(input_param))
    out_ps = ps_net(Tensor(x), Tensor(y), Tensor(input_param))
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = ControlOneWhileOnePara(input_shape)
    jit(function=ControlOneWhileOnePara.construct, capture_mode="bytecode")(pi_net, Tensor(x), Tensor(y), Tensor(input_param))
    out_pi = pi_net(Tensor(x), Tensor(y), Tensor(input_param))
    match_array(out_pi.asnumpy(), out_ps.asnumpy())
...
def test_ctrl_bool_while_addn_true():
    ...
    jit(function=ControlOneBoolWhileOneAddn.construct, capture_mode="ast")(ps_net, Tensor(x), Tensor(y), Tensor(input_param))
    out_ps = ps_net(Tensor(x), Tensor(y), Tensor(input_param))
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = ControlOneBoolWhileOneAddn()
    jit(function=ControlOneBoolWhileOneAddn.construct, capture_mode="bytecode")(pi_net, Tensor(x), Tensor(y), Tensor(input_param))
    out_pi = pi_net(Tensor(x), Tensor(y), Tensor(input_param))
    match_array(out_pi.asnumpy(), out_ps.asnumpy())
