...
def test_control_flow_for_while_return_in_for_x():
    ...
    jit(function=CtrlForReturnWhileX.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForReturnWhileX()
    jit(function=CtrlForReturnWhileX.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
...
def test_control_flow_for_while_return_in_for():
    ...
    jit(function=CtrlForReturnWhile.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForReturnWhile()
    jit(function=CtrlForReturnWhile.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_while_for_param_return_in_for():
    ...
    jit(function=CtrlForWhileReturnOne.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileReturnOne(t)
    jit(function=CtrlForWhileReturnOne.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_by_while_return_no_param():
    ...
    jit(function=CtrlForWhileReturnAdd.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileReturnAdd()
    jit(function=CtrlForWhileReturnAdd.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_by_while_return_in_while_x():
    ...
    jit(function=CtrlForWhileReturnX.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileReturnX()
    jit(function=CtrlForWhileReturnX.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_while_return_in_while():
    ...
    jit(function=CtrlForWhileReturn.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileReturn()
    jit(function=CtrlForWhileReturn.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_while_return_in_while_param():
    ...
    jit(function=CtrlForWhileReturnP.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileReturnP(t)
    jit(function=CtrlForWhileReturnP.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_while_return_in_while_no():
    ...
    jit(function=CtrlForWhileReturnN.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileReturnN()
    jit(function=CtrlForWhileReturnN.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
