...
def test_control_flow_for_while_continue_in_for_x():
    ...
    jit(function=CtrlForContinueWhileX.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForContinueWhileX()
    jit(function=CtrlForContinueWhileX.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
...
def test_control_flow_for_while_continue_in_for():
    ...
    jit(function=CtrlForContinueWhile.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForContinueWhile()
    jit(function=CtrlForContinueWhile.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_while_for_param_continue_in_for():
    ...
    jit(function=CtrlForWhileContinueOne.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileContinueOne(t)
    jit(function=CtrlForWhileContinueOne.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_by_while_continue_no_param():
    ...
    jit(function=CtrlForWhileContinueAdd.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileContinueAdd()
    jit(function=CtrlForWhileContinueAdd.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_by_while_continue_in_while_x():
    ...
    jit(function=CtrlForWhileContinueX.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileContinueX()
    jit(function=CtrlForWhileContinueX.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_while_continue_in_while():
    ...
    jit(function=CtrlForWhileContinue.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileContinue()
    jit(function=CtrlForWhileContinue.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_while_continue_in_while_param():
    ...
    jit(function=CtrlForWhileContinueP.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileContinueP(t)
    jit(function=CtrlForWhileContinueP.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_while_continue_in_while_no():
    ...
    jit(function=CtrlForWhileContinueN.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForWhileContinueN()
    jit(function=CtrlForWhileContinueN.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
