...
def test_control_flow_for_range_1_10_3_return():
    ...
    jit(function=CtrlForReturnRange1.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForReturnRange1()
    jit(function=CtrlForReturnRange1.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
...
def test_control_flow_for_range_4_n8_n4_return():
    ...
    jit(function=CtrlForReturnRange2.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForReturnRange2()
    jit(function=CtrlForReturnRange2.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_range_n5_5_2_return():
    ...
    jit(function=CtrlForReturnRange3.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForReturnRange3()
    jit(function=CtrlForReturnRange3.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_range_n2_n8_n2_return():
    ...
    jit(function=CtrlForReturnRange4.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForReturnRange4()
    jit(function=CtrlForReturnRange4.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_return_in_elif_else():
    ...
    jit(function=CtrlForReturnElifElse.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForReturnElifElse()
    jit(function=CtrlForReturnElifElse.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
...
def test_control_flow_for_2elif_return_in_if():
    ...
    jit(function=CtrlFor2ElifReturnInIf.construct, capture_mode="bytecode")(pi_net, x)
    pi_net(x)
...
def test_control_flow_for_return_fib():
    ...
    jit(function=CtrlForReturnAll.construct, capture_mode="ast")(ps_net, x)
    ps_out = ps_net(x)
    context.set_context(mode=context.PYNATIVE_MODE)
    pi_net = CtrlForReturnAll()
    jit(function=CtrlForReturnAll.construct, capture_mode="bytecode")(pi_net, x)
    pi_out = pi_net(x)
    match_array(ps_out, pi_out)
