...
def jit_sub_mul(a, b, c):
    return a - b * c


@arg_mark(plat_marks=['cpu_linux'], level_mark='level0', card_mark='onecard', essential_mark='essential')
@pytest.mark.parametrize('ms_func', [jit_sub_mul])
...
def test_sub_mul(ms_func, a, b, c):
    """
    Feature: ALL TO ALL
    Description: test cases for sub_mul in PYNATIVE mode
