...
class FloorDivDynamicShapeFactory():
    ...
    def forward_cmp(self):
        ...
        jit(ps_net.construct, capture_mode="ast")(self.input_x, self.input_y, self.indices)
        context.set_context(mode=context.GRAPH_MODE)
        out_ps = self.forward_mindspore_impl(ps_net)
        pi_net = FloorDivDynamicShapeNetMS()
        jit(pi_net.construct, capture_mode="bytecode")(self.input_x, self.input_y, self.indices)
