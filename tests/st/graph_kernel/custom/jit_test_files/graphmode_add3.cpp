...
class OPS_API CustomAddOpFuncImpl3 : public OpFuncImpl {
 public:
...
CustomAddOpFuncImpl3 gCustomAddFuncImpl3;
OpDef gCustomAdd3 = {
  /*.name_=*/"Custom_add3",
  /*.args_=*/
  {
  ...
  /*.func_impl_=*/gCustomAddFuncImpl3,
  /*.enable_dispatch_ =*/true,
  /*.is_view_ =*/false,
  /*.is_graph_view_ =*/false,
};
REGISTER_PRIMITIVE_OP_DEF(Custom_add3, &gCustomAdd3);
...
namespace mindspore {
namespace kernel {
class CustomAddAscend3 : public AclnnKernelMod {
 public:
  CustomAddAscend3() : AclnnKernelMod(std::move("aclnnAdd")) {}
  ~CustomAddAscend3() = default;
...
MS_ACLNN_KERNEL_FACTORY_REG(Custom_add3, CustomAddAscend3);

}  // namespace kernel
}  // namespace mindspore

REG_GRAPH_MODE_OP(add3);
