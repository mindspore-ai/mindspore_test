...
@arg_mark(plat_marks=["platform_ascend910b"], level_mark="level1", card_mark="allcards", essential_mark="essential")
def test_ops_flash_attention_score_load_balance():
    """
    Feature: Test the accuracy of flash attention with load balance.
    Description: Test function flash attention score forward.
    Expectation: The result of standalone and semi_parallel is equal.
    """
    return_code = os.system(
        "msrun --worker_num=8 --local_worker_num=8 --master_addr=127.0.0.1 " \
