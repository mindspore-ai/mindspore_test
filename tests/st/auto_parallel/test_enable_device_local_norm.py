...
def test_msrun_enable_device_local_norm():
    '''
    ...
    return_code = os.system(
        ...
        "--master_port=10820 --join=True --log_dir=./enable_device_local_norm_log "
        "pytest -s enable_device_local_norm.py::test_enable_device_local_norm"
    )
