...
export TBE_IMPL_PATH=${LOCAL_HIAI}/cann/opp/built-in/op_impl/ai_core/tbe/impl/:${TBE_IMPL_PATH}
export LD_LIBRARY_PATH=${LOCAL_HIAI}/cann/lib64/:${LOCAL_HIAI}/add-ons/:${LD_LIBRARY_PATH}
