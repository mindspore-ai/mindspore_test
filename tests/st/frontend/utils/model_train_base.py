...
from .file_tools import clean_all_ckpt_files
from .file_tools import find_newest_ckpt_file
from .file_tools import find_newest_ckpt_file_by_name
...
class ModelTrainBase:
    ...
    def load_newest_ckpt_from_model_train(self, model, epoch, dataset, dataset_sink_mode=True, user_callback=None,
                                          ...
                                          integrated_save=True, format="ckpt", # pylint: disable=redefined-builtin
                                          load_format="default"):
        ...
        ckpt_config = CheckpointConfig(keep_checkpoint_max=5, integrated_save=integrated_save,
                                       ...
                                       async_save=async_save, format=format)
        ...
        user_callback = [] if user_callback is None else user_callback
        ...
        if load_format == "default":
            ...
            newest_ckpt_file = find_newest_ckpt_file_by_name(ckpt_path, format=format)
        self.save_ckpt = True
        self.ckpt_path = ckpt_path
        return load_checkpoint(newest_ckpt_file, format=format)
