...
from mindspore.dataset.dataloader._utils.worker import _generate_state, WorkerInfo, WorkerException
from tests.mark_utils import arg_mark


@arg_mark(plat_marks=['cpu_linux'], level_mark='level0', card_mark='onecard', essential_mark='essential')
@pytest.mark.parametrize("base_seed", (0, 18))
@pytest.mark.parametrize("worker_id", (0, 1, 2))
def test_generate_state(base_seed, worker_id):
    """
    ...
    """
    state = _generate_state(base_seed, worker_id)
    np_state = np.random.bit_generator.SeedSequence([worker_id, base_seed & 0xFFFFFFFF, base_seed >> 32,
                                                     0]).generate_state(4)
...
class TestWorker:
    ...
    def test_worker_info_unmodifiable(self):
        ...
        with pytest.raises(RuntimeError,
                           match="Cannot modify the attributes of WorkerInfo object after initialization"):
            worker_info.id = 2
