...
def test_nan_to_num_std(mode):
    ...
    if mode == 'pynative':
        ...
        output = (jit(nan_to_num_forward_func, jit_level="O0"))(ms.Tensor(x), nan_num, inf_num,
                                                                                      neg_inf_num)
        output_grad = (jit(nan_to_num_backward_func, jit_level="O0"))(ms.Tensor(x), nan_num,
                                                                                            inf_num, neg_inf_num)
    else:
        output = (jit(nan_to_num_forward_func, jit_level="O2"))(ms.Tensor(x), nan_num, inf_num,
                                                                                      neg_inf_num)
        output_grad = (jit(nan_to_num_backward_func, jit_level="O2"))(ms.Tensor(x), nan_num,
                                                                                            inf_num, neg_inf_num)
