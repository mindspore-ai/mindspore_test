...
def test_bernoulli_normal(mode):
    ...
    if mode == 'pynative':
        ...
        output = (jit(bernoulli_forward_func, jit_config=JitConfig(jit_level="O0")))(input_x, generator=generator)
    else:
        context.set_context(mode=ms.GRAPH_MODE)
        output = bernoulli_forward_func(input_x, generator=generator)
    ...
    if mode == 'pynative':
        ...
        context.set_context(mode=ms.GRAPH_MODE)
        input_grad = (jit(bernoulli_backward_func, jit_config=JitConfig(jit_level="O0")))(input_x, generator=generator)
    else:
        context.set_context(mode=ms.GRAPH_MODE)
        input_grad = bernoulli_backward_func(input_x, generator=generator)
...
def test_bernoulli_randomness(mode):
    ...
    if mode == 'pynative':
        ...
        context.set_context(mode=ms.GRAPH_MODE)
        output1 = (jit(bernoulli_forward_func, jit_config=JitConfig(jit_level="O0")))(input_x, generator=generator)
        output2 = (jit(bernoulli_forward_func, jit_config=JitConfig(jit_level="O0")))(input_x, generator=generator)
    else:
        context.set_context(mode=ms.GRAPH_MODE)
        output1 = bernoulli_forward_func(input_x, generator=generator)
        output2 = bernoulli_forward_func(input_x, generator=generator)
