...
def split_forward_func(x, split_sizee, dim):
    return split(x, split_sizee, dim)


@test_utils.run_with_cell
def split_backward_func(x, split_sizee, dim):
    return ops.grad(split_forward_func, (0,))(x, split_sizee, dim) # pylint: disable=not-callable
