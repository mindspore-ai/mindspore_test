...
def test_ops_irfft2_normal(mode):
    """
    Feature: ops.irfftn
    Description: test function irfftn forward and auto grad.
    Expectation: success
    """
...
def test_ops_irfft2_dynamic_shape(mode):
    """
    Feature: ops.irfftn
    Description: test function irfftn forward and auto grad with dynamic shape.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
...
def test_ops_irfft2_dynamic_rank(mode):
    """
    Feature: ops.irfftn
    Description: test function irfftn forward and auto grad with dynamic rank.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
