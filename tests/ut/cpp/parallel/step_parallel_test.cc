...
CNodePtr Make_Node(Shape x, Shape y, Shape out, int64_t condition = 0) {
  ...
  std::shared_ptr<tensor::Tensor> inputs_x = tensor::from_spec(kNumberTypeInt32, x, device::DeviceType::kCPU);
  std::shared_ptr<tensor::Tensor> inputs_y = tensor::from_spec(kNumberTypeInt32, y, device::DeviceType::kCPU);
  std::shared_ptr<tensor::Tensor> inputs_out = tensor::from_spec(kNumberTypeInt32, out, device::DeviceType::kCPU);
...
FuncGraphManagerPtr Make_Manager(int64_t condition = 0) {
  ...
  std::shared_ptr<tensor::Tensor> inputs_x_dim = tensor::from_spec(kNumberTypeInt32, inputs_x, device::DeviceType::kCPU);
  std::shared_ptr<tensor::Tensor> inputs_y_dim = tensor::from_spec(kNumberTypeInt32, inputs_y, device::DeviceType::kCPU);
  std::shared_ptr<tensor::Tensor> inputs_z_dim = tensor::from_spec(kNumberTypeInt32, inputs_z, device::DeviceType::kCPU);
  std::shared_ptr<tensor::Tensor> inputs_out1_dim = tensor::from_spec(kNumberTypeInt32, outputs_1, device::DeviceType::kCPU);
  std::shared_ptr<tensor::Tensor> inputs_out2_dim = tensor::from_spec(kNumberTypeInt32, outputs_2, device::DeviceType::kCPU);
