...
/// Feature: Test graph kernel Erf expander
/// Description: Erf will expanded
/// Expectation: After expand, the output shape and data type of sub graph should match expect
class TestErfExpander : public TestGraphKernelExpander, public testing::WithParamInterface<ErfParams> {
  void SetUp() override {
