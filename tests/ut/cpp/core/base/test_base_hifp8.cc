...
int main() {
  float test_values[] = {
    ...
    2.0f, 4.0f, -8.0f, 16.f, -32.5f,
    3.14f, -2.71f, 100.0f, -100.0f,
    1023.0f, 4792.0f, 9301.0f, -10020.0f,
  ...
  for (float f32 : test_values) {
    uint8_t float8_bits = HiFloat8::FromFloat32(f32);
    HiFloat8 float8 = HiFloat8::FromRaw(float8_bits);
    float f32_converted = HiFloat8::ToFloat32(float8);
    ...
    std::cout << "HiFloat8 hex: 0x" << std::hex << std::setw(2) << std::setfill('0')
              << static_cast<int>(float8_bits) << std::dec << std::endl;
    std::cout << "HiFloat8 bits: " << std::bitset<8>(float8_bits).to_string().substr(0,1)
              << " | " << std::bitset<8>(float8_bits).to_string().substr(1,7) << std::endl;
    std::cout << "               (S | D + E + M )" << std::endl;
