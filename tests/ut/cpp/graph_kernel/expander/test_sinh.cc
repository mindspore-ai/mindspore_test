...
/// Feature: Test graph kernel Sinh expander
/// Description: Sinh will expanded
/// Expectation: After expand, the output shape and data type of sub graph should match expect
class TestSinhExpander : public TestGraphKernelExpander, public testing::WithParamInterface<SinhParams> {
  void SetUp() override {
...
INSTANTIATE_TEST_CASE_P(TestOpSinh, TestSinhExpander, testing::Values(SinhParams{{16, 16}, {16, 16}, kFloat32}));
}  // namespace mindspore::graphkernel::test