...
/// Feature: Test graph kernel Tanh expander
/// Description: Tanh will expanded
/// Expectation: After expand, the output shape and data type of sub graph should match expect
class TestTanhExpander : public TestGraphKernelExpander, public testing::WithParamInterface<TanhParams> {
  void SetUp() override {
...
INSTANTIATE_TEST_CASE_P(TestOpTanh, TestTanhExpander, testing::Values(TanhParams{{16, 16}, {16, 16}, kFloat32}));
}  // namespace mindspore::graphkernel::test