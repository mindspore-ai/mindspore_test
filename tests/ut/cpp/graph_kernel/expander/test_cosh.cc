...
/// Feature: Test graph kernel Cosh expander
/// Description: Cosh will expanded
/// Expectation: After expand, the output shape and data type of sub graph should match expect
class TestCoshExpander : public TestGraphKernelExpander, public testing::WithParamInterface<CoshParams> {
  void SetUp() override {
...
INSTANTIATE_TEST_CASE_P(TestOpCosh, TestCoshExpander, testing::Values(CoshParams{{16, 16}, {16, 16}, kFloat32}));
}  // namespace mindspore::graphkernel::test