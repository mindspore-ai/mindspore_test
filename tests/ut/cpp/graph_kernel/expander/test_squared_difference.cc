...
/// Feature: Test SquaredDifference expander
/// Description: test op with different inputs
/// Expectation: Can be expanded only when its input data types are supported.
class TestSquaredDifferenceExpander : public TestGraphKernelExpander, public testing::WithParamInterface<Params> {
  void SetUp() override { SetDeviceTarget(kAscendDevice); }
};

TEST_P(TestSquaredDifferenceExpander, squared_difference) {
  ...
  auto op = c.NewCNodeWithBuildInfo("SquaredDifference", inputs);
  c.SetOutput(op);
  auto fg = c.GetGraph();
...
INSTANTIATE_TEST_CASE_P(TestOpSquaredDifference, TestSquaredDifferenceExpander,
                        testing::Values(Params{true, {kFloat16, kFloat16}, {{2, 3}, {2, 3}}},
                                        Params{true, {kFloat32, kFloat32}, {{2, 3}, {2, 3}}},
                                        Params{true, {kFloat16, kFloat16}, {{2, 3}, {2, 1}}},
                                        Params{true, {kFloat16, kFloat16}, {{2, 3}, {1, 3}}},
                                        Params{true, {kFloat16, kFloat16}, {{2, 3}, {1, 1}}},
                                        Params{true, {kFloat16, kFloat16}, {{2, 3}, {1}}},
                                        Params{true, {kFloat16, kFloat16}, {{2, 3}, {}}},
                                        Params{true, {kFloat16, kFloat16}, {{1}, {2, 3}}},
                                        Params{false, {kFloat64, kFloat64}, {{2, 3}, {2, 3}}},
                                        Params{false, {kInt32, kInt32}, {{2, 3}, {2, 3}}},
