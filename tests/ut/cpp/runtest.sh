...
#pids=()
tasks=(./ut_CORE_tests ./ut_ERROR_HANDLE_tests ./ut_FRONTEND_tests ./ut_BACKEND_tests ./ut_PS_tests ./ut_OTHERS_tests ./ut_MINDDATA0_tests ./ut_MINDDATA1_tests ./ut_CCSRC_tests ./ut_SYMBOL_ENGINE_tests ./ut_GRAPH_KERNEL_tests ./ut_INTERNAL_KERNEL_tests)
