...
INSTANTIATE_TEST_CASE_P(Norm, GeneralInferTest, testing::ValuesIn(prepare_params()));
INSTANTIATE_TEST_CASE_P(LinalgVectorNorm, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops
