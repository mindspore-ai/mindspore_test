...
namespace mindspore {
namespace ops {
OP_FUNC_IMPL_INFER_TEST_DECLARE(Log1p, EltwiseOpParams);
OP_FUNC_IMPL_INFER_TEST_CASES(Log1p, testing::Values(EltwiseOpParams{{2, 3}, kFloat16, {2, 3}, kFloat16},
                                                     ...
                                                     EltwiseOpParams{{2, 3}, kComplex64, {2, 3}, kComplex64},
                                                     EltwiseOpParams{{2, 3}, kComplex128, {2, 3}, kComplex128},
