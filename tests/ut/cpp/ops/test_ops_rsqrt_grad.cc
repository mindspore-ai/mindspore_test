...
#include "infer/ops_func_impl/rsqrt_grad.h"
...
TEST_P(TestRsqrtGrad, dyn_shape) {
  ...
  DoFuncImplInferAndCompare<RsqrtGradFuncImpl>(kNameRsqrtGrad, {grad, x}, expect_shape, expect_type);
}

INSTANTIATE_TEST_CASE_P(TestRsqrtGradGroup, TestRsqrtGrad,
                        testing::Combine(EltwiseGradDynShapeTestCases,
                                         testing::ValuesIn({EltwiseGradOpTypeParams{kFloat16, kFloat16, kFloat16},
                                                            ...
                                                            EltwiseGradOpTypeParams{kComplex128, kComplex128,
                                                                                    kComplex128}})));
}  // namespace ops
}  // namespace mindspore
