...
TEST_P(TestConstantPadND, dyn_shape) {
  ...
  DoFuncImplInferAndCompare<ConstantPadNDFuncImpl>(kNameConstantPadND, {x, padding, constant_value}, expect_shape,
                                                   expect_type);
}
...
static std::vector<ConstantPadNDParams> GetCases() {
  ...
  std::vector<ConstantPadNDParams> cases = {
    ConstantPadNDParams{{4, 2, 3}, kFloat32, CreatePyIntTuple({1, 1}), CreateScalar(1), {4, 2, 5}, kFloat32},
    ConstantPadNDParams{{dyn_rank}, kFloat32, CreatePyIntTuple({dyn_dim, 1}), CreateScalar(1), {dyn_rank}, kFloat32},
    ConstantPadNDParams{
      {4, dyn_dim, dyn_dim}, kFloat32, CreatePyIntTuple({1, 1}), CreateScalar(1), {4, dyn_dim, dyn_dim}, kFloat32},
    ConstantPadNDParams{
      {4, dyn_dim, dyn_dim}, kFloat32, kValueAny, CreateScalar(1), {dyn_dim, dyn_dim, dyn_dim}, kFloat32},
    ConstantPadNDParams{{4, dyn_dim, dyn_dim},
                        kFloat32,
                        CreatePyIntTuple({dyn_dim, 1}),
                        CreateScalar(1),
                        {4, dyn_dim, dyn_dim},
                        kFloat32}};
  return cases;
