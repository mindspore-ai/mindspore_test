...
OP_FUNC_IMPL_TEST_CASES(
  InplaceAddmm,
  testing::Values(MultiInputOpParams{{{2, 4}, {2, 3}, {3, 4}},
                                     {kFloat16, kFloat16, kFloat16},
                                     {{2, 4}},
                                     {kFloat16},
                                     {CreateScalar<int>(1), CreateScalar<double>(2)}},
                  MultiInputOpParams{{{2, 5}, {2, 4}, {4, 5}},
                                     {kFloat32, kFloat32, kFloat32},
                                     {{2, 5}},
                                     {kFloat32},
                                     {CreateScalar<double>(3), CreateScalar<int>(4)}},
                  MultiInputOpParams{{{2, 3}, {2, 3}, {3, 4}},
                                     {kFloat16, kFloat16, kFloat16},
                                     {{2, 3}},
                                     {kFloat16},
                                     {CreateScalar<double>(1), CreateScalar<double>(2)}},
                  MultiInputOpParams{
                    {{-1, -1}, {2, 3}, {3, 4}}, {kFloat16, kFloat16, kFloat16}, {{-1, -1}}, {kFloat16}, {}},
                  MultiInputOpParams{{{-2}, {2, 3}, {3, 4}},
                                     {kFloat32, kFloat32, kFloat32},
                                     {{-2}},
                                     {kFloat32},
                                     {CreateScalar<double>(1), CreateScalar<double>(2)}},
                  MultiInputOpParams{{{-2}, {-2}, {-2}}, {kFloat32, kFloat32, kFloat32}, {{-2}}, {kFloat32}, {}},
