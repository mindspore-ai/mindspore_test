...
class TestLess : public TestOps, public testing::WithParamInterface<LessOpParams> {};

TEST_P(TestLess, less_dyn_shape) {
  auto primitive = std::make_shared<Primitive>("Less");
  ...
  auto infer_impl = std::make_shared<LessFuncImpl>();
