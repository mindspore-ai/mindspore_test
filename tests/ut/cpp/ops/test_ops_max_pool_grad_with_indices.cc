...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    .FeedInputArgs(
      {InferInfoParam{ShapeVector{1, 3, -1, -1}, kNumberTypeFloat32},
       InferInfoParam{ShapeVector{-1, -1, -1, -1}, kNumberTypeFloat32},
       InferInfoParam{ShapeVector{-1, -1, -1, -1}, kNumberTypeFloat32},
       InferInfoParam{ShapeArray{{}, {}}, TypeIdList{kNumberTypeInt64, kNumberTypeInt64},
                      ValuePtrList{CreateScalar<int64_t>(4), CreateScalar<int64_t>(4)}},
       ...
       InferInfoParam{ShapeVector{}, kNumberTypeBool, CreateScalar<bool>(false)},
       InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(static_cast<int64_t>(kNumberTypeInt64))}})
    .FeedExpectedOutput({{1, 3, -1, -1}}, {kNumberTypeFloat32});

  generator
    .FeedInputArgs(
      {InferInfoParam{ShapeVector{1, 3, 5, 5}, kNumberTypeFloat32},
       InferInfoParam{ShapeVector{-1, -1, -1, -1}, kNumberTypeFloat32},
       InferInfoParam{ShapeVector{-1, -1, -1, -1}, kNumberTypeFloat32},
       InferInfoParam{ShapeArray{{}, {}}, TypeIdList{kNumberTypeInt64, kNumberTypeInt64},
                      ValuePtrList{CreateScalar<int64_t>(4), CreateScalar<int64_t>(4)}},
       ...
       InferInfoParam{ShapeVector{}, kNumberTypeBool, CreateScalar<bool>(false)},
       InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(static_cast<int64_t>(kNumberTypeInt64))}})
    .FeedExpectedOutput({{1, 3, 5, 5}}, {kNumberTypeFloat32});

  return generator.Generate();
}
}  // namespace

INSTANTIATE_TEST_CASE_P(MaxPoolGradWithIndices, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops
