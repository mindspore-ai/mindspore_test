...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{2, 3, 4}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt32, CreateScalar<int32_t>(1)},
                    InferInfoParam{ShapeVector{{}, {}}, kNumberTypeInt32,
                                   ValuePtrList{CreateScalar<int64_t>(1), CreateScalar<int64_t>(2)}},
                    InferInfoParam{ShapeVector{2, 2, 4}, kNumberTypeFloat32},
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-1, -1, 4}, kNumberTypeFloat32},
                    ...
                    InferInfoParam{ShapeVector{{}, {}}, kNumberTypeInt32,
                                   ValuePtrList{CreateScalar<int64_t>(1), CreateScalar<int64_t>(2)}},
                    InferInfoParam{ShapeVector{-1, -1, 2}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{}, kNumberTypeFloat32, CreateScalar<float>(2.0)}})
    .FeedExpectedOutput({{-1, -1, 4}}, {kNumberTypeFloat32});
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-2}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt32},
                    InferInfoParam{ShapeVector{{}}, kNumberTypeInt32, ValuePtrList{CreateScalar<int64_t>(0)}},
...
INSTANTIATE_TEST_CASE_P(InplaceIndexAddExt, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops
