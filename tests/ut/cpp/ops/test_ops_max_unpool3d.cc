...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{1, 2, 2, 2}, kNumberTypeFloat64},
                    InferInfoParam{ShapeVector{1, 2, 2, 2}, kNumberTypeInt64},
                    ...
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, ValuePtrList{CreateScalar<int64_t>(0)}},
                    InferInfoParam{ShapeVector{}, kMetaTypeNone, mindspore::kNone}})
    .FeedExpectedOutput({{1, 3, 3, 3}}, {kNumberTypeFloat64});
  generator
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{1, 3, 3, 4}, kNumberTypeFloat64},
                    ...
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, ValuePtrList{CreateScalar<int64_t>(1)}},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, ValuePtrList{CreateScalar<int64_t>(0)}},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, ValuePtrList{kValueAny, kValueAny, kValueAny}}})
    .FeedExpectedOutput({{1, -1, -1, -1}}, {kNumberTypeFloat64});
  generator
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-1, -1, -1, 2}, kNumberTypeFloat64},
                    ...
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, ValuePtrList{CreateScalar<int64_t>(0)}},
                    InferInfoParam{ShapeVector{}, kMetaTypeNone, mindspore::kNone}})
    .FeedExpectedOutput({{1, 2, 3, 3}}, {kNumberTypeFloat64});
  return generator.Generate();
}
}  // namespace
INSTANTIATE_TEST_CASE_P(MaxUnpool3DExt, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops