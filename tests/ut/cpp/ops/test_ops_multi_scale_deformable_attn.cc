...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    ...
    .FeedExpectedOutput({{2, 3, 20}}, {kNumberTypeFloat32});
  generator
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-1, -1, 2, 3}, kNumberTypeFloat32},
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-1, -1, -1, -1}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{-1, -1}, kNumberTypeInt32},
                    InferInfoParam{ShapeVector{-1}, kNumberTypeInt32},
                    InferInfoParam{ShapeVector{-1, 4, 3, -1, -1, -1}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{2, -1, 3, -1, -1}, kNumberTypeFloat32}})
    .FeedExpectedOutput({{2, 4, -1}}, {kNumberTypeFloat32});
  return generator.Generate();
}
}  // namespace

INSTANTIATE_TEST_CASE_P(MultiScaleDeformableAttn, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops
