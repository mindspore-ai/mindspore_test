...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    ...
    .FeedExpectedOutput({{2, -1}, {2, -1}}, {kNumberTypeFloat32, kNumberTypeFloat32});
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-1, -1}, kNumberTypeFloat32}})
    .FeedExpectedOutput({{-1, -1}, {-1, -1}}, {kNumberTypeFloat32, kNumberTypeFloat32});
  generator
...
INSTANTIATE_TEST_CASE_P(LogSigmoid, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops
