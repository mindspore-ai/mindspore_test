...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{3, 10, 10, 10, 10}, kNumberTypeFloat32},
    ...
    .FeedExpectedOutput({{3, 10, 3, 3, 3}}, {kNumberTypeFloat32});
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{3, 10, 10, 10, 10}, kNumberTypeFloat32},
                    ...
                    InferInfoParam{ShapeVector{}, kNumberTypeBool, CreateScalar<bool>(true)},
                    InferInfoParam{ShapeVector{}, kMetaTypeNone, mindspore::kNone}})
    .FeedExpectedOutput({{3, 10, 9, 9, 9}}, {kNumberTypeFloat32});
  ...
  generator
    .FeedInputArgs(
      {InferInfoParam{ShapeVector{3, 10, 10, 10, 10}, kNumberTypeFloat32},
       ...
       InferInfoParam{ShapeArray{{}}, kNumberTypeInt64,
                      ValuePtrList{CreateScalar<int64_t>(1), CreateScalar<int64_t>(4), CreateScalar<int64_t>(1)}},
       InferInfoParam{ShapeArray{{}}, kNumberTypeInt64,
                      ValuePtrList{CreateScalar<int64_t>(1), CreateScalar<int64_t>(0), CreateScalar<int64_t>(1)}},
       InferInfoParam{ShapeVector{}, kNumberTypeBool, CreateScalar<bool>(true)},
       InferInfoParam{ShapeVector{}, kNumberTypeBool, CreateScalar<bool>(true)},
       InferInfoParam{ShapeVector{}, kMetaTypeNone, mindspore::kNone}})
    .FeedExpectedOutput({{3, 10, 9, 3, 9}}, {kNumberTypeFloat32});
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-1, -1, 10, 10, 10}, kNumberTypeFloat32},
                    InferInfoParam{ShapeArray{{}}, kNumberTypeInt64, ValuePtrList{CreateScalar<int64_t>(4)}},
                    InferInfoParam{ShapeArray{{}}, kNumberTypeInt64, ValuePtrList{CreateScalar<int64_t>(4)}},
                    InferInfoParam{ShapeArray{{}}, kNumberTypeInt64, ValuePtrList{CreateScalar<int64_t>(0)}},
                    InferInfoParam{ShapeVector{}, kNumberTypeBool, CreateScalar<bool>(false)},
                    InferInfoParam{ShapeVector{}, kNumberTypeBool, CreateScalar<bool>(true)},
                    InferInfoParam{ShapeVector{}, kMetaTypeNone, mindspore::kNone}})
    .FeedExpectedOutput({{-1, -1, 2, 2, 2}}, {kNumberTypeFloat32});
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{3, 10, 10, 10, 10}, kNumberTypeFloat32},
                    ...
                    InferInfoParam{ShapeVector{}, kNumberTypeBool, CreateScalar<bool>(true)},
                    InferInfoParam{ShapeVector{}, kMetaTypeNone, mindspore::kNone}})
    .FeedExpectedOutput({{3, 10, -1, -1, -1}}, {kNumberTypeFloat32});
...
INSTANTIATE_TEST_CASE_P(AvgPool3DExt, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace ops
}  // namespace mindspore