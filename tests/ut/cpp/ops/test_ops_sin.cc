...
#include "infer/ops_func_impl/sin.h"

namespace mindspore {
namespace ops {
OP_FUNC_IMPL_TEST_DECLARE(Sin, EltwiseOpParams);

OP_FUNC_IMPL_TEST_CASES(Sin, testing::Values(EltwiseOpParams{{2, 3}, kBool, {2, 3}, kFloat32},
