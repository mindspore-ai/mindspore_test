...
namespace mindspore {
namespace ops {
OP_FUNC_IMPL_TEST_DECLARE(CholeskyGrad, MultiInputOpParams);

OP_FUNC_IMPL_TEST_CASES(
  CholeskyGrad,
  testing::Values(
    MultiInputOpParams{{{2, 2}, {2, 2}}, {kFloat32, kFloat32}, {{2, 2}}, {kFloat32}, {CreateScalar<bool>(true)}},
    MultiInputOpParams{{{2, -1}, {2, 2}}, {kFloat32, kFloat32}, {{2, 2}}, {kFloat32}, {CreateScalar(kValueAny)}},
    MultiInputOpParams{{{2, 2}, {2, -1}}, {kFloat32, kFloat32}, {{2, 2}}, {kFloat32}, {CreateScalar(kValueAny)}},
