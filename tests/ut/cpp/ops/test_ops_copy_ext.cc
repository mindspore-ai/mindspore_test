...
namespace mindspore {
namespace ops {
OP_FUNC_IMPL_INFER_TEST_DECLARE(CopyExt, MultiInputOpParams);
...
OP_FUNC_IMPL_INFER_TEST_CASES(
  ...
  testing::Values(MultiInputOpParams{{{1}, {1}}, {kFloat16, kFloat16}, {{1}}, {kFloat16}, {}},
                  ...
                  MultiInputOpParams{{{1, 2}, {-2}}, {kUInt16, kUInt16}, {{1, 2}}, {kUInt16}, {}},
                  MultiInputOpParams{{{2, 3}, {3}}, {kUInt32, kFloat32}, {{2, 3}}, {kUInt32}, {}},
                  MultiInputOpParams{{{2, 3}, {3}}, {kUInt64, kFloat32}, {{2, 3}}, {kUInt64}, {}},
                  MultiInputOpParams{{{-1, -1}, {1, 2}}, {kBool, kBool}, {{-1, -1}}, {kBool}, {}},
                  MultiInputOpParams{{{-2}, {-1}}, {kComplex64, kComplex64}, {{-2}}, {kComplex64}, {}},
