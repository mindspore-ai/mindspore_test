...
namespace mindspore {
namespace ops {
class TestMinimum : public TestOps, public testing::WithParamInterface<BroadcastOpParams> {};

TEST_P(TestMinimum, minimum_dyn_shape) {
  auto primitive = std::make_shared<Primitive>("Minimum");
  ...
  auto infer_impl = std::make_shared<MinimumFuncImpl>();
