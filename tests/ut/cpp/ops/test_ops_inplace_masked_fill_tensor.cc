...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{3, 3}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{3, 3}, kNumberTypeFloat32},
...
INSTANTIATE_TEST_CASE_P(InplaceMaskedFillTensor, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops
