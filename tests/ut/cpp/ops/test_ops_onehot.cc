...
#include "infer/ops_func_impl/one_hot.h"
...
INSTANTIATE_TEST_CASE_P(
  ...
  testing::Values(
    ...
    OneHotOpParams{{2, 2, 3},
                   ...
                   kInt32},
    OneHotOpParams{
      {-2}, kInt32, CreateScalar(kValueAny), {1}, kInt32, {0}, kInt32, CreateScalar(kValueAny), {-2}, kInt32},
    OneHotOpParams{{2, 2, 3},
                   kInt32,
