...
INSTANTIATE_TEST_CASE_P(
  ...
  testing::Values(
    SoftplusExtParams{ShapeVector{2, 3, 4}, kFloat32, CreateScalar<int64_t>(2), CreateScalar<int64_t>(8),
                      ShapeVector{2, 3, 4}},
    SoftplusExtParams{ShapeVector{2, 3, 4}, kFloat16, CreateScalar(kValueAny), CreateScalar<int64_t>(8),
                      ShapeVector{2, 3, 4}},
    SoftplusExtParams{ShapeVector{2, 3, 4}, kBFloat16, CreateScalar<int64_t>(2), CreateScalar(kValueAny),
                      ShapeVector{2, 3, 4}},
    SoftplusExtParams{ShapeVector{2, 3, 4}, kBFloat16, CreateScalar(kValueAny), CreateScalar(kValueAny),
                      ShapeVector{2, 3, 4}},
    SoftplusExtParams{ShapeVector{-1, 2, -1}, kFloat32, CreateScalar<int64_t>(2), CreateScalar<int64_t>(8),
                      ShapeVector{-1, 2, -1}},
    SoftplusExtParams{ShapeVector{-1, 2, -1}, kFloat32, CreateScalar<int64_t>(2), CreateScalar(kValueAny),
                      ShapeVector{-1, 2, -1}},
    SoftplusExtParams{ShapeVector{-1, 2, -1}, kFloat32, CreateScalar(kValueAny), CreateScalar<int64_t>(8),
                      ShapeVector{-1, 2, -1}},
    SoftplusExtParams{ShapeVector{-1, 2, -1}, kFloat32, CreateScalar(kValueAny), CreateScalar(kValueAny),
                      ShapeVector{-1, 2, -1}},
