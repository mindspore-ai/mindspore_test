...
class TestPowScalarTensor : public TestOps, public testing::WithParamInterface<EltwiseOpParams> {};

TEST_P(TestPowScalarTensor, pow_scalar_tensor_dyn_shape) {
  ...
  auto infer_impl = std::make_shared<PowScalarTensorFuncImpl>();
...
INSTANTIATE_TEST_CASE_P(
  TestPowScalarTensorGroup, TestPowScalarTensor,
