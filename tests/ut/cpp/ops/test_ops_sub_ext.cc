...
#include "infer/ops_func_impl/sub_ext.h"
...
auto SubExtOpShapeTestCases =
  testing::ValuesIn({/* y is number */
                     SubExtShape{{10}, {}, CreateScalar<int64_t>(2), {10}},
                     SubExtShape{{10, 1, 2}, {}, CreateScalar<int64_t>(2), {10, 1, 2}},
                     SubExtShape{{10, 4, 2}, {}, CreateScalar<int64_t>(2), {10, 4, 2}},
                     SubExtShape{{10, 1, -1}, {}, CreateScalar<int64_t>(2), {10, 1, -1}},
                     ...
                     SubExtShape{{2, 1, 4, 5, 6, 9}, {-2}, CreateScalar<int64_t>(2), {-2}},
                     SubExtShape{{2, 1, 4, 5, -1, 9}, {-2}, CreateScalar<int64_t>(2), {-2}},
                     SubExtShape{{-2}, {2, 1, 4, 5, 6, 9}, CreateScalar<int64_t>(2), {-2}},
                     SubExtShape{{-2}, {2, 1, 4, 5, -1, 9}, CreateScalar<int64_t>(2), {-2}},
