...
std::vector<GeneralInferParam> prepare_params() {
    ...
    .FeedInputArgs({InferInfoParam{ShapeVector{1, 1, 6, 6}, kNumberTypeFloat32},
                    ...
                    InferInfoParam{ShapeArray{{}, {}, {}, {}}, kNumberTypeInt64,
                                   ValuePtrList{CreateScalar<int64_t>(1), CreateScalar<int64_t>(1),
                                                CreateScalar<int64_t>(2), CreateScalar<int64_t>(2)}},
                    InferInfoParam{ShapeArray{{}, {}}, kNumberTypeInt64,
                                   ValuePtrList{CreateScalar<int64_t>(6), CreateScalar<int64_t>(6)}},
  ...
  generator
    ...
    .FeedExpectedOutput({{1, -1, 2, 2}}, {kNumberTypeFloat32});
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{1, 2, 6, 6}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{1, 5}, kNumberTypeFloat32},
                    InferInfoParam{ShapeArray{{}, {}, {}, {}}, kNumberTypeInt64,
                                   ValuePtrList{kValueAny, CreateScalar<int64_t>(2), kValueAny, kValueAny}},
                    InferInfoParam{ShapeArray{{}, {}}, kNumberTypeInt64,
                                   ValuePtrList{CreateScalar<int64_t>(6), CreateScalar<int64_t>(6)}},
                    InferInfoParam{ShapeVector{}, kNumberTypeFloat32, CreateScalar<float>(1.2)},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(-1)},
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-2}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{1, 5}, kNumberTypeFloat32},
                    InferInfoParam{ShapeArray{{}, {}, {}, {}}, kNumberTypeInt64,
                                   ValuePtrList{kValueAny, kValueAny, kValueAny, kValueAny}},
                    InferInfoParam{ShapeArray{{}, {}}, kNumberTypeInt64,
                                   ValuePtrList{CreateScalar<int64_t>(6), CreateScalar<int64_t>(6)}},
                    InferInfoParam{ShapeVector{}, kNumberTypeFloat32, CreateScalar<float>(1.2)},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(-1)},
...
INSTANTIATE_TEST_CASE_P(RoiAlignGradExt, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops
