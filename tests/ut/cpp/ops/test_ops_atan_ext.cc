...
#include "infer/ops_func_impl/atan_ext.h"

namespace mindspore {
namespace ops {
OP_FUNC_IMPL_INFER_TEST_DECLARE(AtanExt, EltwiseOpParams);

OP_FUNC_IMPL_INFER_TEST_CASES(AtanExt, testing::Values(EltwiseOpParams{{2, 3}, kBool, {2, 3}, kFloat32},
                                                       EltwiseOpParams{{2, 3}, kUInt8, {2, 3}, kFloat32},
                                                       EltwiseOpParams{{2, 3}, kInt8, {2, 3}, kFloat32},
                                                       EltwiseOpParams{{2, 3}, kInt16, {2, 3}, kFloat32},
                                                       EltwiseOpParams{{-2}, kInt32, {-2}, kFloat32},
