...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    .FeedInputArgs({
      ...
      InferInfoParam{ShapeVector{}, kNumberTypeFloat64, CreateScalar<double>(0.1)},
  ...
  generator
    .FeedInputArgs({
      InferInfoParam{ShapeVector{-1, 8, -1, 96}, kNumberTypeFloat32},
    ...
    .FeedExpectedOutput({{-1, 8, -1, 96}, {8}, {8}}, {kNumberTypeFloat32, kNumberTypeFloat32, kNumberTypeFloat32});
...
INSTANTIATE_TEST_CASE_P(BatchNormExt, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace ops
}  // namespace mindspore
