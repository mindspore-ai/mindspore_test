...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{6, 7, 8, 9}, kNumberTypeFloat16},
                    ...
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(2)}})
    .FeedExpectedOutput({{}, {}}, {kNumberTypeFloat16, kNumberTypeFloat32});
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{5, 7, 3, 4}, kNumberTypeBFloat16},
                    InferInfoParam{ShapeVector{5, 3, 4}, kNumberTypeUInt8},
                    InferInfoParam{ShapeVector{7}, kNumberTypeFloat16},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(2)},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(2)}})
    .FeedExpectedOutput({{5, 3, 4}, {}}, {kNumberTypeBFloat16, kNumberTypeFloat16});
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{9, 4, 7, 3}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{9, 7, 3}, kNumberTypeInt32},
                    InferInfoParam{ShapeVector{4}, kNumberTypeBFloat16},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(0)},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(2)}})
    .FeedExpectedOutput({{}, {}}, {kNumberTypeFloat32, kNumberTypeBFloat16});
  generator
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-1, -1, -1, -1}, kNumberTypeFloat32},
                    ...
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(2)},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(2)}})
    .FeedExpectedOutput({{-1, -1, -1}, {}}, {kNumberTypeFloat32, kNumberTypeBFloat16});
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-2}, kNumberTypeFloat32},
                    ...
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(2)},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(2)}})
    .FeedExpectedOutput({{-2}, {}}, {kNumberTypeFloat32, kNumberTypeBFloat16});
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-2}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{-2}, kNumberTypeInt32},
                    InferInfoParam{ShapeVector{-2}, kNumberTypeBFloat16},
...
INSTANTIATE_TEST_CASE_P(NLLLoss2d, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops
