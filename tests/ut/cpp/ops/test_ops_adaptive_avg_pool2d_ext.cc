...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    ...
    .FeedExpectedOutput({{2, 2, 4}}, {kNumberTypeFloat32});
  ...
  generator
    ...
    .FeedExpectedOutput({{4, 3, 4, 6}}, {kNumberTypeFloat32});
  
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-1, 3, 4, 5}, kNumberTypeFloat32},
                    InferInfoParam{ShapeArray{{}, {}}, kNumberTypeInt64,
                    ValuePtrList{CreateScalar<int64_t>(4), CreateScalar<int64_t>(6)}}})
    .FeedExpectedOutput({{-1, 3, 4, 6}}, {kNumberTypeFloat32});
...
INSTANTIATE_TEST_CASE_P(AdaptiveAvgPool2DExt, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops
