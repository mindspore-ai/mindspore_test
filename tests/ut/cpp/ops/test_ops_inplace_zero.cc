...
namespace mindspore {
namespace ops {
OP_FUNC_IMPL_INFER_TEST_DECLARE(InplaceZero, MultiInputOpParams);
...
OP_FUNC_IMPL_INFER_TEST_CASES(
  ...
  testing::Values(MultiInputOpParams{{{1}}, {kFloat16}, {{1}}, {kFloat16}, {}},
                  ...
                  MultiInputOpParams{{{1, 2}}, {kUInt16}, {{1, 2}}, {kUInt16}, {}},
                  MultiInputOpParams{{{2, 3}}, {kUInt32}, {{2, 3}}, {kUInt32}, {}},
                  MultiInputOpParams{{{2, 3}}, {kUInt64}, {{2, 3}}, {kUInt64}, {}},
                  MultiInputOpParams{{{-1, -1}}, {kBool}, {{-1, -1}}, {kBool}, {}},
                  MultiInputOpParams{{{-2}}, {kComplex64}, {{-2}}, {kComplex64}, {}},
                  MultiInputOpParams{{{-2}}, {kComplex128}, {{-2}}, {kComplex128}, {}}));
}  // namespace ops
}  // namespace mindspore
