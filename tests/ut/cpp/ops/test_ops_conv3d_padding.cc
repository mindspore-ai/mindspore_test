...
std::vector<GeneralInferParam> prepare_params() {
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-2}, kNumberTypeFloat32},
                    ...
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreatePyInt(PadMode::SAME)},
                    InferInfoParam{ShapeArray{{}, {}, {}}, kNumberTypeInt64,
                      ValuePtrList{CreateScalar<int64_t>(1), CreateScalar<int64_t>(1), CreateScalar<int64_t>(1)}},
  ...
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{2, 3, 4, 4, 4}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{-1, -1, 2, 2, 2}, kNumberTypeFloat32},
    ...
    .FeedExpectedOutput({{2, -1, 4, 4, 4}}, {kNumberTypeFloat32});

  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{-1, 3, 4, 4, 4}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{1, 3, 2, 2, 2}, kNumberTypeFloat32},
    ...
    .FeedExpectedOutput({{-1, 1, 4, 4, 4}}, {kNumberTypeFloat32});
...
INSTANTIATE_TEST_CASE_P(Conv3DPadding, GeneralInferTest, testing::ValuesIn(prepare_params()));
}  // namespace mindspore::ops