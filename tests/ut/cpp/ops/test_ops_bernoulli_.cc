...
namespace {
std::vector<GeneralInferParam> prepare_params_tensor() {
...
std::vector<GeneralInferParam> prepare_params_float() {
  GeneralInferParamGenerator generator;
  generator
    .FeedInputArgs({InferInfoParam{ShapeVector{2, 3}, kNumberTypeFloat32},
                    InferInfoParam{ShapeVector{}, kNumberTypeFloat32, CreateScalar(kValueAny)},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(0)},
                    InferInfoParam{ShapeVector{}, kNumberTypeInt64, CreateScalar<int64_t>(0)}})
    .FeedExpectedOutput({{2, 3}}, {kNumberTypeFloat32});
  generator
...
INSTANTIATE_TEST_CASE_P(InplaceBernoulliTensor, GeneralInferTest, testing::ValuesIn(prepare_params_tensor()));
INSTANTIATE_TEST_CASE_P(InplaceBernoulliScalar, GeneralInferTest, testing::ValuesIn(prepare_params_float()));
}  // namespace mindspore::ops
