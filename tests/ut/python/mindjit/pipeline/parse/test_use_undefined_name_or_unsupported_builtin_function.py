...
def test_use_undefined_name():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:29" in \
           str(err.value)
...
def test_insert_undefined_name():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:44" in \
           str(err.value)
...
def test_insert_undefined_name_compute():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:59" in \
           str(err.value)
...
def test_insert_undefined_name_in_if():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:76" in \
           str(err.value)
...
def test_insert_undefined_name_in_while_inner_if():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:93" in \
           str(err.value)
...
def test_insert_undefined_name_compute__in_while_inner_if():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:111" in \
           str(err.value)
...
def test_insert_undefined_name_compute__in_if_in_for():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:134" in \
           str(err.value)
...
def test_use_undefined_name_for_inner_if():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:157" in \
           str(err.value)
...
def test_use_undefined_name_in_for():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:178" in \
           str(err.value)
...
def test_insert_undefined_name_in_for():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:198" in \
           str(err.value)
...
def test_insert_undefined_name_compute_in_for():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:219" in \
           str(err.value)
...
def test_use_undefined_name_in_while():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:236" in \
           str(err.value)
...
def test_insert_undefined_name_in_while():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:252" in \
           str(err.value)
...
def test_insert_undefined_name_compute_while():
    ...
    with pytest.raises(NameError) as err:
        net(Tensor([1, 2, 3], mstype.float32))
    assert "The name 'i' is not defined" in str(err.value)
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:269" in \
           str(err.value)
...
def test_call_none_in_if():
    ...
    with pytest.raises(AttributeError) as err:
        net(Tensor([1, 2, 3], mstype.float32))
    assert "has no attribute" in str(err.value)
...
def test_call_unsupported_builtin_function_in_while():
    ...
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:342" in str(
        err.value)
...
def test_call_unsupported_builtin_function_in_if_in_for():
    ...
    with pytest.raises(NameError) as err:
        net(Tensor([1, 2, 3], mstype.float32))
    assert "The builtin function 'divmod' of python is not supported in graph mode" in str(err.value)
    assert "tests/ut/python/mindjit/pipeline/parse/test_use_undefined_name_or_unsupported_builtin_function.py:364" in \
           str(err.value)
