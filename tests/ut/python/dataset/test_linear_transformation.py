...
def test_linear_transformation_operation_01():
    ...
    """
    # LinearTransformation operator: Normal testing, Numpy Image shape = (3, 3, 4)
    data_dir = os.path.join(TEST_DATA_DATASET_FUNC, "test_data", "imagenet", "imagenet_file_jpg1")
    transformation_matrix = np.ones([36, 36])
    mean_vector = np.ones([36])
    ...
    # LinearTransformation operator: Normal testing, Numpy Image shape = (3, 5, 7)
    data_dir = os.path.join(TEST_DATA_DATASET_FUNC, "test_data", "imagenet", "imagenet_file_jpg1")
    transformation_matrix = np.ones([105, 105])
    mean_vector = np.ones([105])
    dataset = ds.ImageFolderDataset(data_dir)
    transforms = [vision.Decode(),
                  vision.Resize(5),
                  vision.ToTensor(),
    ...
    # LinearTransformation operator: Normal testing, Numpy Image shape = (3, 10, 14)
    data_dir = os.path.join(TEST_DATA_DATASET_FUNC, "test_data", "imagenet", "imagenet_file_jpg1")
    transformation_matrix = np.ones([420, 420])
    mean_vector = np.ones([420])
    dataset = ds.ImageFolderDataset(data_dir)
...
def test_linear_transformation_operation_02():
    ...
    Expectation: The Output is equal to the expected output
    """
    # LinearTransformation operator: Normal testing, Numpy Image shape = (3, 16, 23)
    data_dir = os.path.join(TEST_DATA_DATASET_FUNC, "test_data", "imagenet", "imagenet_file_jpg1")
    transformation_matrix = np.ones([1104, 1104])
    mean_vector = np.ones([1104])
    dataset = ds.ImageFolderDataset(data_dir)
    ...
    # LinearTransformation operator: Normal testing, Numpy Image shape = (3, 20, 29)
    data_dir = os.path.join(TEST_DATA_DATASET_FUNC, "test_data", "imagenet", "imagenet_file_jpg1")
    transformation_matrix = np.ones([1740, 1740])
    mean_vector = np.ones([1740])
    dataset = ds.ImageFolderDataset(data_dir)
    transforms = [vision.Decode(to_pil=True),
                  vision.Resize(20),
                  vision.ToTensor(),
    ...
    # LinearTransformation operator: Normal testing, Numpy Image shape = (3, 25, 37)
    data_dir = os.path.join(TEST_DATA_DATASET_FUNC, "test_data", "imagenet", "imagenet_file_jpg1")
    transformation_matrix = np.ones([2775, 2775])
    mean_vector = np.ones([2775])
    dataset = ds.ImageFolderDataset(data_dir)
    transforms = [vision.Decode(),
                  vision.Resize(25),
                  vision.ToTensor(),
...
def test_linear_transformation_operation_03():
    ...
    Expectation: The Output is equal to the expected output
    """
    # LinearTransformation operator: Normal testing, Numpy Image shape = (3, 32, 47)
    data_dir = os.path.join(TEST_DATA_DATASET_FUNC, "test_data", "imagenet", "imagenet_file_jpg1")
    transformation_matrix = np.ones([4512, 4512])
    mean_vector = np.ones([4512])
    dataset = ds.ImageFolderDataset(data_dir)
    transforms = [vision.Decode(to_pil=True),
                  vision.Resize(32),
                  vision.ToTensor(),
