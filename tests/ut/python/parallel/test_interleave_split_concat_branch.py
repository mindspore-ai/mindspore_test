...
def setup_function():
    ...
    context.set_context(mode=context.GRAPH_MODE, save_graphs=True, save_graphs_path="./split_concat_branch_interleave")


def check_output(num_comm_ops=10):
    file = "./split_concat_branch_interleave/rank_0/*validate*.ir"
    prim_name = "Depend("
...
def test_interleave_split_concat_branch(split_count):
    ...
    if os.path.exists("./split_concat_branch_interleave/rank_0"):
        shutil.rmtree("./split_concat_branch_interleave/rank_0")
