...
def test_rfft2_auto_parallel():
    """
    Feature: test RFFT2 auto parallel
    Description: auto parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="auto_parallel", search_mode="sharding_propagation", device_num=4,
...
def test_rfft2_model_parallel():
    """
    Feature: test RFFT2 model parallel
    Description: model parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.RFFT2(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 1, 1),))))
    net.set_train()
    _cell_graph_executor.compile(net, r_)


def test_rfft2_strategy_error():
    """
    Feature: test invalid strategy for RFFT2
    Description: illegal strategy
    Expectation: raise RuntimeError
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.RFFT2(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 2, 1),))))
    net.set_train()
    with pytest.raises(RuntimeError):
        _cell_graph_executor.compile(net, r_)


def test_irfft2_auto_parallel():
    """
    Feature: test IRFFT2 auto parallel
    Description: auto parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="auto_parallel", search_mode="sharding_propagation", device_num=4,
...
def test_irfft2_model_parallel():
    """
    Feature: test IRFFT2 model parallel
    Description: model parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.IRFFT2(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 1, 1),))))
    net.set_train()
    _cell_graph_executor.compile(net, r_)


def test_irfft2_strategy_error():
    """
    Feature: test invalid strategy for IRFFT2
    Description: illegal strategy
    Expectation: raise RuntimeError
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.IRFFT2(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 2, 1),))))
    net.set_train()
    with pytest.raises(RuntimeError):
        _cell_graph_executor.compile(net, r_)


def test_rfftn_auto_parallel():
    """
    Feature: test RFFTN auto parallel
    Description: auto parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="auto_parallel", search_mode="sharding_propagation", device_num=4,
...
def test_rfftn_model_parallel():
    """
    Feature: test RFFTN model parallel
    Description: model parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.RFFTN(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 1, 1),))))
    net.set_train()
    _cell_graph_executor.compile(net, r_)


def test_rfftn_strategy_error():
    """
    Feature: test invalid strategy for RFFTN
    Description: illegal strategy
    Expectation: raise RuntimeError
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.RFFTN(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 2, 1),))))
    net.set_train()
    with pytest.raises(RuntimeError):
        _cell_graph_executor.compile(net, r_)


def test_irfftn_auto_parallel():
    """
    Feature: test IRFFTN auto parallel
    Description: auto parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="auto_parallel", search_mode="sharding_propagation", device_num=4,
...
def test_irfftn_model_parallel():
    """
    Feature: test IRFFTN model parallel
    Description: model parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.IRFFTN(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 1, 1),))))
    net.set_train()
    _cell_graph_executor.compile(net, r_)


def test_irfftn_strategy_error():
    """
    Feature: test invalid strategy for IRFFTN
    Description: illegal strategy
    Expectation: raise RuntimeError
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.IRFFTN(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 2, 1),))))
    net.set_train()
    with pytest.raises(RuntimeError):
        _cell_graph_executor.compile(net, r_)


def test_hfft_auto_parallel():
    """
    Feature: test HFFT auto parallel
    Description: auto parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="auto_parallel", search_mode="sharding_propagation", device_num=4,
...
def test_hfft_model_parallel():
    """
    Feature: test HFFT model parallel
    Description: model parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.HFFT(), n=4, dim=0, norm="backward", strategy=((1, 2, 2),))))
    net.set_train()
    _cell_graph_executor.compile(net, r_)


def test_hfft_strategy_error():
    """
    Feature: test invalid strategy for HFFT
    Description: illegal strategy
    Expectation: raise RuntimeError
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.HFFT(), n=4, dim=0, norm="backward", strategy=((2, 2, 1),))))
    net.set_train()
    with pytest.raises(RuntimeError):
        _cell_graph_executor.compile(net, r_)


def test_ihfft_auto_parallel():
    """
    Feature: test IHFFT auto parallel
    Description: auto parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="auto_parallel", search_mode="sharding_propagation", device_num=4,
...
def test_ihfft_model_parallel():
    """
    Feature: test IHFFT model parallel
    Description: model parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.IHFFT(), n=4, dim=0, norm="backward", strategy=((1, 2, 2),))))
    net.set_train()
    _cell_graph_executor.compile(net, r_)


def test_ihfft_strategy_error():
    """
    Feature: test invalid strategy for IHFFT
    Description: illegal strategy
    Expectation: raise RuntimeError
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.IHFFT(), n=4, dim=0, norm="backward", strategy=((2, 2, 1),))))
    net.set_train()
    with pytest.raises(RuntimeError):
        _cell_graph_executor.compile(net, r_)


def test_hfft2_auto_parallel():
    """
    Feature: test HFFT2 auto parallel
    Description: auto parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="auto_parallel", search_mode="sharding_propagation", device_num=4,
...
def test_hfft2_model_parallel():
    """
    Feature: test HFFT2 model parallel
    Description: model parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.HFFT2(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 1, 1),))))
    net.set_train()
    _cell_graph_executor.compile(net, r_)


def test_hfft2_strategy_error():
    """
    Feature: test invalid strategy for HFFT2
    Description: illegal strategy
    Expectation: raise RuntimeError
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.HFFT2(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 2, 1),))))
    net.set_train()
    with pytest.raises(RuntimeError):
        _cell_graph_executor.compile(net, r_)


def test_ihfft2_auto_parallel():
    """
    Feature: test IHFFT2 auto parallel
    Description: auto parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="auto_parallel", search_mode="sharding_propagation", device_num=4,
...
def test_ihfft2_model_parallel():
    """
    Feature: test IHFFT2 model parallel
    Description: model parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.IHFFT2(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 1, 1),))))
    net.set_train()
    _cell_graph_executor.compile(net, r_)


def test_ihfft2_strategy_error():
    """
    Feature: test invalid strategy for IHFFT2
    Description: illegal strategy
    Expectation: raise RuntimeError
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.IHFFT2(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 2, 1),))))
    net.set_train()
    with pytest.raises(RuntimeError):
        _cell_graph_executor.compile(net, r_)


def test_hfftn_auto_parallel():
    """
    Feature: test HFFTN auto parallel
    Description: auto parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="auto_parallel", search_mode="sharding_propagation", device_num=4,
...
def test_hfftn_model_parallel():
    """
    Feature: test HFFTN model parallel
    Description: model parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.HFFTN(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 1, 1),))))
    net.set_train()
    _cell_graph_executor.compile(net, r_)


def test_hfftn_strategy_error():
    """
    Feature: test invalid strategy for HFFTN
    Description: illegal strategy
    Expectation: raise RuntimeError
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.HFFTN(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 2, 1),))))
    net.set_train()
    with pytest.raises(RuntimeError):
        _cell_graph_executor.compile(net, r_)


def test_ihfftn_auto_parallel():
    """
    Feature: test IHFFTN auto parallel
    Description: auto parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="auto_parallel", search_mode="sharding_propagation", device_num=4,
...
def test_ihfftn_model_parallel():
    """
    Feature: test IHFFTN model parallel
    Description: model parallel
    Expectation: compile success
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.IHFFTN(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 1, 1),))))
    net.set_train()
    _cell_graph_executor.compile(net, r_)


def test_ihfftn_strategy_error():
    """
    Feature: test invalid strategy for IHFFTN
    Description: illegal strategy
    Expectation: raise RuntimeError
    """
    context.set_auto_parallel_context(parallel_mode="semi_auto_parallel", device_num=4, global_rank=0)
    net = GradWrap(NetWithLoss(Net(P.IHFFTN(), n=(4, 4), dim=(-2, -1), norm="backward", strategy=((2, 2, 1),))))
    net.set_train()
    with pytest.raises(RuntimeError):
        _cell_graph_executor.compile(net, r_)
