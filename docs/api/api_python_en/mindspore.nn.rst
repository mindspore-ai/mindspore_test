...
For more information about dynamic shape support status, please refer to `Dynamic Shape Support Status of nn Interface <https://mindspore.cn/docs/en/master/api_python/dynamic_shape_nn.html>`_ .
