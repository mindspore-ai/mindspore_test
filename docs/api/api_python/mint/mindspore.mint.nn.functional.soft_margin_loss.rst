mindspore.mint.nn.functional.soft_margin_loss
===============================================

.. py:function:: mindspore.mint.nn.functional.soft_margin_loss(input, target, reduction='mean')
    ...
    参数：
        ...
        - **target** (Tensor) - 真实标签，shape与 `input` 相同。
