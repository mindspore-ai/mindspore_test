...
.. py:class:: mindspore.ops.Div
    ...
    .. note::
        ...
        - 两个输入不能同时为bool类型。[True, Tensor(True, bool), Tensor(np.array([True]), bool)]等都为bool类型。
    ...
    输入：
        ...
        - **y** (Union[Tensor, number.Number, bool]) - 第二个输入，是一个number.Number、bool值或数据类型为 `number <https://www.mindspore.cn/docs/zh-CN/master/api_python/mindspore/mindspore.dtype.html#mindspore.dtype>`_ 或 `bool <https://www.mindspore.cn/docs/zh-CN/master/api_python/mindspore/mindspore.dtype.html#mindspore.dtype>`_ 的Tensor。
