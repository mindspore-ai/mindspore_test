...
.. py:function:: mindspore.tensor(input_data=None, dtype=None, shape=None, init=None, internal=False, const_arg=False)
    ...
    此接口与Tensor类的区别为内部增加了 `Annotation <https://www.mindspore.cn/docs/zh-CN/master/model_train/program_form/static_graph.html#annotation-type>`_ 指示当前创建的Tensor的类型，与Tensor类相比能够防止AnyType的产生。
