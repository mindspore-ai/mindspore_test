...
.. py:class:: mindspore.dataset.audio.BandBiquad(sample_rate, central_freq, Q=0.707, noise=False)
    ...
    带通滤波器的频率响应在中心频率附近呈对数下降，下降的斜率由带宽决定。频带两端处输出音频的幅度为原始幅度的一半。
    ...
    参数：
        ...
        - **Q** (float, 可选) - `品质因子 <https://zh.wikipedia.org/wiki/%E5%93%81%E8%B3%AA%E5%9B%A0%E5%AD%90>`_ ，反映带宽与采样频率、中心频率的关系，取值范围为(0, 1]。默认值： ``0.707`` 。
